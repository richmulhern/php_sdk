...
class AriaBillingComplete extends BaseAriaBilling
{
     ...
     * @param int $primary_or_bkup_pay_method_ind Indicates whether to update primary or secondary payment method.
     * @param int $ref_bkup_seq_no The unique bill sequence number of the existing payment method on account to be set as backup payment method.
    ...
    public function update_payment_method($account_number, $first_name = null, $last_name = null, $middle_initial = null, $company_name = null, $address1 = null, $address2 = null, $city = null, $locality = null, $state = null, $country = null, $zip = null, $intl_phone = null, $phone_npa = null, $phone_nxx = null, $phone_suffix = null, $phone_extension = null, $email = null, $pay_method = null, $cc_number = null, $cc_expire_mm = null, $cc_expire_yyyy = null, $bank_routing_num = null, $bank_acct_num = null, $do_collect = null, $change_status_after_coll = null, $reset_dates_after_status = null, $client_receipt_id = null, $iban = null, $bank_check_digit = null, $bank_swift_cd = null, $bank_country_cd = null, $mandate_id = null, $bank_id_cd = null, $bank_branch_cd = null, $primary_or_bkup_pay_method_ind = null, $ref_bkup_seq_no = null)
    {
        return $this->__ws_call('update_payment_method', Array(
                ...
                'primary_or_bkup_pay_method_ind' => $primary_or_bkup_pay_method_ind,
                'ref_bkup_seq_no' => $ref_bkup_seq_no
        ));
    }
     ...
     * @param string $bank_id_cd Up to 10 digit numeric bank identifier code. Used for the Direct Debit payment method. Used in Europe.  Only hyphen and space are allowed to format the bank id code. It is required for BBAN.
     * @param string $bank_branch_cd Up to 10 digit numeric bank branch code. Used for the Direct Debit payment method. Used in Europe.  Only hyphen and space are allowed to format the bank branch code.
     * @param string $bkup_bill_first_name First name of the secondary billing contact
     * @param string $bkup_bill_mi Middle Initial of the secondary billing contact
     * @param string $bkup_bill_last_name Last name of the secondary billing contact
     * @param string $bkup_bill_company_name Company name of the secondary billing contact
     * @param string $bkup_bill_address1 First address line of the secondary billing contact
     * @param string $bkup_bill_address2 second address line of the secondary billing contact
     * @param string $bkup_bill_address3 second address line of the secondary billing contact
     * @param string $bkup_bill_city City of the secondary billing contact
     * @param string $bkup_bill_locality Locality of the secondary billing contact
     * @param string $bkup_bill_state_prov State or Province of the secondary billing contact. The official postal-service codes for all United States and Canada states, provinces, and territories.
     * @param string $bkup_bill_country Country of the secondary billing contact. The ISO-compliant 2-character country code abbreviation in uppercase.
     * @param string $bkup_bill_postal_cd This is the postal code for the secondary billing contact address.
     * @param string $bkup_bill_phone Phone of the secondary billing contact
     * @param string $bkup_bill_phone_ext This is the secondary billing contacts extension for the bill_phone given.
     * @param string $bkup_bill_cell_phone Cell phone of the secondary billing contact
     * @param string $bkup_bill_work_phone Work phone of the secondary billing contact
     * @param string $bkup_bill_work_phone_ext This is the work phone extension for the secondary billing contact work phone.
     * @param string $bkup_bill_email Email of the secondary billing contact
     * @param int $bkup_pay_method This is the method_id corresponding to a secondary payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $bkup_cc_number Credit card number.
     * @param int $bkup_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param int $bkup_cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param string $bkup_bank_acct_no This is the bank account number of the account holder&#039;s payment method. Together with the (ABA) bank_routing_no, this value is used to execute electronic check or ACH transactions.
     * @param string $bkup_bank_routing_no This is the ABA (American Banking Association) unique identifier for the fincancial institution.
     * @param string $bkup_bill_agreement_id Unique ID of the secondary bill agreement.
     * @param string $bkup_cvv Card Verification Value, used to help verify a transaction is being requested by the secondary card holder since this value is physically printed on the credit card.
     * @param string $seq_func_group_id Unique Functional account group id specifically designated for statement sequence number assignment.
     * @param int $revrec_profile_id Profile ID of an existing Revenue Recognition Profile.
     * @param string $revrec_client_defined_id Client Defined Identifier of an existing Revenue Recognition Profile.  If this  parameter is specified it will take precedence over revrec_profile_id.
    ...
    public function create_acct_complete($alt_start_date = null, $client_acct_id = null, $userid = null, $status_cd = null, $master_plan_no = null, $master_plan_units = null, $supp_plans = null, $supp_plan_units = null, $notify_method = null, $promo_cd = null, $password = null, $secret_question = null, $secret_question_answer = null, $first_name = null, $mi = null, $last_name = null, $company_name = null, $address1 = null, $address2 = null, $city = null, $locality = null, $state_prov = null, $country = null, $postal_cd = null, $phone = null, $phone_ext = null, $cell_phone = null, $work_phone = null, $work_phone_ext = null, $email = null, $birthdate = null, $bill_first_name = null, $bill_mi = null, $bill_last_name = null, $bill_company_name = null, $bill_address1 = null, $bill_address2 = null, $bill_city = null, $bill_locality = null, $bill_state_prov = null, $bill_country = null, $bill_postal_cd = null, $bill_phone = null, $bill_phone_ext = null, $bill_cell_phone = null, $bill_work_phone = null, $bill_work_phone_ext = null, $bill_email = null, $pay_method = null, $cc_number = null, $cc_expire_mm = null, $cc_expire_yyyy = null, $bank_acct_no = null, $bank_routing_no = null, $resp_level_cd = null, $senior_acct_no = null, $senior_acct_user_id = null, $client_senior_acct_id = null, $functional_acct_groups = null, $collections_acct_groups = null, $supp_field_names = null, $supp_field_values = null, $test_acct_ind = null, $status_until_alt_start = null, $balance_forward = null, $alt_bill_day = null, $do_full_invoicing = null, $do_prorated_invoicing = null, $master_plan_alt_rate_sched_no = null, $supp_plan_alt_rate_sched_no = null, $client_receipt_id = null, $currency_cd = null, $cvv = null, $taxpayer_id = null, $bill_agreement_id = null, $retroactive_start_date = null, $coupon_codes = null, $new_acct_custom_rates = null, $alt_msg_template_no = null, $seq_func_group_no = null, $new_acct_plan_contracts = null, $address3 = null, $bill_address3 = null, $usage_accumulation_config = null, $enable_usage_pooling_plan_no = null, $client_func_acct_group_ids = null, $client_coll_acct_group_ids = null, $track_data1 = null, $track_data2 = null, $do_write = null, $tax_exemption_level = null, $cn_alt_msg_template_no = null, $invoice_approval_required = null, $create_session = null, $client_master_plan_id = null, $client_supp_plan_ids = null, $client_mp_alt_rate_sched_id = null, $client_sp_alt_rate_sched_ids = null, $client_alt_msg_template_id = null, $client_cn_alt_msg_template_no = null, $surcharge_no = null, $iban = null, $bank_check_digit = null, $bank_swift_cd = null, $bank_country_cd = null, $mandate_id = null, $bank_id_cd = null, $bank_branch_cd = null, $bkup_bill_first_name = null, $bkup_bill_mi = null, $bkup_bill_last_name = null, $bkup_bill_company_name = null, $bkup_bill_address1 = null, $bkup_bill_address2 = null, $bkup_bill_address3 = null, $bkup_bill_city = null, $bkup_bill_locality = null, $bkup_bill_state_prov = null, $bkup_bill_country = null, $bkup_bill_postal_cd = null, $bkup_bill_phone = null, $bkup_bill_phone_ext = null, $bkup_bill_cell_phone = null, $bkup_bill_work_phone = null, $bkup_bill_work_phone_ext = null, $bkup_bill_email = null, $bkup_pay_method = null, $bkup_cc_number = null, $bkup_cc_expire_mm = null, $bkup_cc_expire_yyyy = null, $bkup_bank_acct_no = null, $bkup_bank_routing_no = null, $bkup_bill_agreement_id = null, $bkup_cvv = null, $seq_func_group_id = null, $revrec_profile_id = null, $revrec_client_defined_id = null)
    {
        return $this->__ws_call('create_acct_complete', Array(
                ...
                'bank_id_cd' => $bank_id_cd,
                'bank_branch_cd' => $bank_branch_cd,
                'bkup_bill_first_name' => $bkup_bill_first_name,
                'bkup_bill_mi' => $bkup_bill_mi,
                'bkup_bill_last_name' => $bkup_bill_last_name,
                'bkup_bill_company_name' => $bkup_bill_company_name,
                'bkup_bill_address1' => $bkup_bill_address1,
                'bkup_bill_address2' => $bkup_bill_address2,
                'bkup_bill_address3' => $bkup_bill_address3,
                'bkup_bill_city' => $bkup_bill_city,
                'bkup_bill_locality' => $bkup_bill_locality,
                'bkup_bill_state_prov' => $bkup_bill_state_prov,
                'bkup_bill_country' => $bkup_bill_country,
                'bkup_bill_postal_cd' => $bkup_bill_postal_cd,
                'bkup_bill_phone' => $bkup_bill_phone,
                'bkup_bill_phone_ext' => $bkup_bill_phone_ext,
                'bkup_bill_cell_phone' => $bkup_bill_cell_phone,
                'bkup_bill_work_phone' => $bkup_bill_work_phone,
                'bkup_bill_work_phone_ext' => $bkup_bill_work_phone_ext,
                'bkup_bill_email' => $bkup_bill_email,
                'bkup_pay_method' => $bkup_pay_method,
                'bkup_cc_number' => $bkup_cc_number,
                'bkup_cc_expire_mm' => $bkup_cc_expire_mm,
                'bkup_cc_expire_yyyy' => $bkup_cc_expire_yyyy,
                'bkup_bank_acct_no' => $bkup_bank_acct_no,
                'bkup_bank_routing_no' => $bkup_bank_routing_no,
                'bkup_bill_agreement_id' => $bkup_bill_agreement_id,
                'bkup_cvv' => $bkup_cvv,
                'seq_func_group_id' => $seq_func_group_id,
                'revrec_profile_id' => $revrec_profile_id,
                'revrec_client_defined_id' => $revrec_client_defined_id
        ));
    }
     ...
     * @param string $a1_bkup_bill_first_name First name of the secondary billing contact
     * @param string $a1_bkup_bill_mi Middle Initial of the secondary billing contact
     * @param string $a1_bkup_bill_last_name Last name of the secondary billing contact
     * @param string $a1_bkup_bill_company_name Company name of the secondary billing contact
     * @param string $a1_bkup_bill_address1 First address line of the secondary billing contact
     * @param string $a1_bkup_bill_address2 second address line of the secondary billing contact
     * @param string $a1_bkup_bill_address3 second address line of the secondary billing contact
     * @param string $a1_bkup_bill_city City of the secondary billing contact
     * @param string $a1_bkup_bill_locality Locality of the secondary billing contact
     * @param string $a1_bkup_bill_state_prov State or Province of the secondary billing contact. The official postal-service codes for all United States and Canada states, provinces, and territories.
     * @param string $a1_bkup_bill_country Country of the secondary billing contact. The ISO-compliant 2-character country code abbreviation in uppercase.
     * @param string $a1_bkup_bill_postal_cd This is the postal code for the secondary billing contact address.
     * @param string $a1_bkup_bill_phone Phone of the secondary billing contact
     * @param string $a1_bkup_bill_phone_ext This is the secondary billing contacts extension for the bill_phone given.
     * @param string $a1_bkup_bill_cell_phone Cell phone of the secondary billing contact
     * @param string $a1_bkup_bill_work_phone Work phone of the secondary billing contact
     * @param string $a1_bkup_bill_work_phone_ext This is the work phone extension for the secondary billing contact work phone.
     * @param string $a1_bkup_bill_email Email of the secondary billing contact
     * @param int $a1_bkup_pay_method This is the method_id corresponding to a secondary payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a1_bkup_cc_number Credit card number.
     * @param int $a1_bkup_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param int $a1_bkup_cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param string $a1_bkup_bank_acct_no This is the bank account number of the account holder&#039;s payment method. Together with the (ABA) bank_routing_no, this value is used to execute electronic check or ACH transactions.
     * @param string $a1_bkup_bank_routing_no This is the ABA (American Banking Association) unique identifier for the fincancial institution.
     * @param string $a1_bkup_bill_agreement_id Unique ID of the secondary bill agreement.
     * @param string $a1_bkup_cvv Card Verification Value, used to help verify a transaction is being requested by the secondary card holder since this value is physically printed on the credit card.
     * @param string $a1_seq_func_group_id Unique Functional account group id specifically designated for statement sequence number assignment.
     * @param int $a1_revrec_profile_id Profile ID of an existing Revenue Recognition Profile.
     * @param string $a1_revrec_client_defined_id Client Defined Identifier of an existing Revenue Recognition Profile.  If this  parameter is specified it will take precedence over revrec_profile_id.
     ...
     * @param string $a2_bkup_bill_first_name First name of the secondary billing contact
     * @param string $a2_bkup_bill_mi Middle Initial of the secondary billing contact
     * @param string $a2_bkup_bill_last_name Last name of the secondary billing contact
     * @param string $a2_bkup_bill_company_name Company name of the secondary billing contact
     * @param string $a2_bkup_bill_address1 First address line of the secondary billing contact
     * @param string $a2_bkup_bill_address2 second address line of the secondary billing contact
     * @param string $a2_bkup_bill_address3 second address line of the secondary billing contact
     * @param string $a2_bkup_bill_city City of the secondary billing contact
     * @param string $a2_bkup_bill_locality Locality of the secondary billing contact
     * @param string $a2_bkup_bill_state_prov State or Province of the secondary billing contact. The official postal-service codes for all United States and Canada states, provinces, and territories.
     * @param string $a2_bkup_bill_country Country of the secondary billing contact. The ISO-compliant 2-character country code abbreviation in uppercase.
     * @param string $a2_bkup_bill_postal_cd This is the postal code for the secondary billing contact address.
     * @param string $a2_bkup_bill_phone Phone of the secondary billing contact
     * @param string $a2_bkup_bill_phone_ext This is the secondary billing contacts extension for the bill_phone given.
     * @param string $a2_bkup_bill_cell_phone Cell phone of the secondary billing contact
     * @param string $a2_bkup_bill_work_phone Work phone of the secondary billing contact
     * @param string $a2_bkup_bill_work_phone_ext This is the work phone extension for the secondary billing contact work phone.
     * @param string $a2_bkup_bill_email Email of the secondary billing contact
     * @param int $a2_bkup_pay_method This is the method_id corresponding to a secondary payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a2_bkup_cc_number Credit card number.
     * @param int $a2_bkup_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param int $a2_bkup_cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param string $a2_bkup_bank_acct_no This is the bank account number of the account holder&#039;s payment method. Together with the (ABA) bank_routing_no, this value is used to execute electronic check or ACH transactions.
     * @param string $a2_bkup_bank_routing_no This is the ABA (American Banking Association) unique identifier for the fincancial institution.
     * @param string $a2_bkup_bill_agreement_id Unique ID of the secondary bill agreement.
     * @param string $a2_bkup_cvv Card Verification Value, used to help verify a transaction is being requested by the secondary card holder since this value is physically printed on the credit card.
     * @param string $a2_seq_func_group_id Unique Functional account group id specifically designated for statement sequence number assignment.
     * @param int $a2_revrec_profile_id Profile ID of an existing Revenue Recognition Profile.
     * @param string $a2_revrec_client_defined_id Client Defined Identifier of an existing Revenue Recognition Profile.  If this  parameter is specified it will take precedence over revrec_profile_id.
     ...
     * @param string $a3_bkup_bill_first_name First name of the secondary billing contact
     * @param string $a3_bkup_bill_mi Middle Initial of the secondary billing contact
     * @param string $a3_bkup_bill_last_name Last name of the secondary billing contact
     * @param string $a3_bkup_bill_company_name Company name of the secondary billing contact
     * @param string $a3_bkup_bill_address1 First address line of the secondary billing contact
     * @param string $a3_bkup_bill_address2 second address line of the secondary billing contact
     * @param string $a3_bkup_bill_address3 second address line of the secondary billing contact
     * @param string $a3_bkup_bill_city City of the secondary billing contact
     * @param string $a3_bkup_bill_locality Locality of the secondary billing contact
     * @param string $a3_bkup_bill_state_prov State or Province of the secondary billing contact. The official postal-service codes for all United States and Canada states, provinces, and territories.
     * @param string $a3_bkup_bill_country Country of the secondary billing contact. The ISO-compliant 2-character country code abbreviation in uppercase.
     * @param string $a3_bkup_bill_postal_cd This is the postal code for the secondary billing contact address.
     * @param string $a3_bkup_bill_phone Phone of the secondary billing contact
     * @param string $a3_bkup_bill_phone_ext This is the secondary billing contacts extension for the bill_phone given.
     * @param string $a3_bkup_bill_cell_phone Cell phone of the secondary billing contact
     * @param string $a3_bkup_bill_work_phone Work phone of the secondary billing contact
     * @param string $a3_bkup_bill_work_phone_ext This is the work phone extension for the secondary billing contact work phone.
     * @param string $a3_bkup_bill_email Email of the secondary billing contact
     * @param int $a3_bkup_pay_method This is the method_id corresponding to a secondary payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a3_bkup_cc_number Credit card number.
     * @param int $a3_bkup_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param int $a3_bkup_cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param string $a3_bkup_bank_acct_no This is the bank account number of the account holder&#039;s payment method. Together with the (ABA) bank_routing_no, this value is used to execute electronic check or ACH transactions.
     * @param string $a3_bkup_bank_routing_no This is the ABA (American Banking Association) unique identifier for the fincancial institution.
     * @param string $a3_bkup_bill_agreement_id Unique ID of the secondary bill agreement.
     * @param string $a3_bkup_cvv Card Verification Value, used to help verify a transaction is being requested by the secondary card holder since this value is physically printed on the credit card.
     * @param string $a3_seq_func_group_id Unique Functional account group id specifically designated for statement sequence number assignment.
     * @param int $a3_revrec_profile_id Profile ID of an existing Revenue Recognition Profile.
     * @param string $a3_revrec_client_defined_id Client Defined Identifier of an existing Revenue Recognition Profile.  If this  parameter is specified it will take precedence over revrec_profile_id.
     ...
     * @param string $a4_bkup_bill_first_name First name of the secondary billing contact
     * @param string $a4_bkup_bill_mi Middle Initial of the secondary billing contact
     * @param string $a4_bkup_bill_last_name Last name of the secondary billing contact
     * @param string $a4_bkup_bill_company_name Company name of the secondary billing contact
     * @param string $a4_bkup_bill_address1 First address line of the secondary billing contact
     * @param string $a4_bkup_bill_address2 second address line of the secondary billing contact
     * @param string $a4_bkup_bill_address3 second address line of the secondary billing contact
     * @param string $a4_bkup_bill_city City of the secondary billing contact
     * @param string $a4_bkup_bill_locality Locality of the secondary billing contact
     * @param string $a4_bkup_bill_state_prov State or Province of the secondary billing contact. The official postal-service codes for all United States and Canada states, provinces, and territories.
     * @param string $a4_bkup_bill_country Country of the secondary billing contact. The ISO-compliant 2-character country code abbreviation in uppercase.
     * @param string $a4_bkup_bill_postal_cd This is the postal code for the secondary billing contact address.
     * @param string $a4_bkup_bill_phone Phone of the secondary billing contact
     * @param string $a4_bkup_bill_phone_ext This is the secondary billing contacts extension for the bill_phone given.
     * @param string $a4_bkup_bill_cell_phone Cell phone of the secondary billing contact
     * @param string $a4_bkup_bill_work_phone Work phone of the secondary billing contact
     * @param string $a4_bkup_bill_work_phone_ext This is the work phone extension for the secondary billing contact work phone.
     * @param string $a4_bkup_bill_email Email of the secondary billing contact
     * @param int $a4_bkup_pay_method This is the method_id corresponding to a secondary payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a4_bkup_cc_number Credit card number.
     * @param int $a4_bkup_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param int $a4_bkup_cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param string $a4_bkup_bank_acct_no This is the bank account number of the account holder&#039;s payment method. Together with the (ABA) bank_routing_no, this value is used to execute electronic check or ACH transactions.
     * @param string $a4_bkup_bank_routing_no This is the ABA (American Banking Association) unique identifier for the fincancial institution.
     * @param string $a4_bkup_bill_agreement_id Unique ID of the secondary bill agreement.
     * @param string $a4_bkup_cvv Card Verification Value, used to help verify a transaction is being requested by the secondary card holder since this value is physically printed on the credit card.
     * @param string $a4_seq_func_group_id Unique Functional account group id specifically designated for statement sequence number assignment.
     * @param int $a4_revrec_profile_id Profile ID of an existing Revenue Recognition Profile.
     * @param string $a4_revrec_client_defined_id Client Defined Identifier of an existing Revenue Recognition Profile.  If this  parameter is specified it will take precedence over revrec_profile_id.
     ...
     * @param string $a5_bkup_bill_first_name First name of the secondary billing contact
     * @param string $a5_bkup_bill_mi Middle Initial of the secondary billing contact
     * @param string $a5_bkup_bill_last_name Last name of the secondary billing contact
     * @param string $a5_bkup_bill_company_name Company name of the secondary billing contact
     * @param string $a5_bkup_bill_address1 First address line of the secondary billing contact
     * @param string $a5_bkup_bill_address2 second address line of the secondary billing contact
     * @param string $a5_bkup_bill_address3 second address line of the secondary billing contact
     * @param string $a5_bkup_bill_city City of the secondary billing contact
     * @param string $a5_bkup_bill_locality Locality of the secondary billing contact
     * @param string $a5_bkup_bill_state_prov State or Province of the secondary billing contact. The official postal-service codes for all United States and Canada states, provinces, and territories.
     * @param string $a5_bkup_bill_country Country of the secondary billing contact. The ISO-compliant 2-character country code abbreviation in uppercase.
     * @param string $a5_bkup_bill_postal_cd This is the postal code for the secondary billing contact address.
     * @param string $a5_bkup_bill_phone Phone of the secondary billing contact
     * @param string $a5_bkup_bill_phone_ext This is the secondary billing contacts extension for the bill_phone given.
     * @param string $a5_bkup_bill_cell_phone Cell phone of the secondary billing contact
     * @param string $a5_bkup_bill_work_phone Work phone of the secondary billing contact
     * @param string $a5_bkup_bill_work_phone_ext This is the work phone extension for the secondary billing contact work phone.
     * @param string $a5_bkup_bill_email Email of the secondary billing contact
     * @param int $a5_bkup_pay_method This is the method_id corresponding to a secondary payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a5_bkup_cc_number Credit card number.
     * @param int $a5_bkup_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param int $a5_bkup_cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param string $a5_bkup_bank_acct_no This is the bank account number of the account holder&#039;s payment method. Together with the (ABA) bank_routing_no, this value is used to execute electronic check or ACH transactions.
     * @param string $a5_bkup_bank_routing_no This is the ABA (American Banking Association) unique identifier for the fincancial institution.
     * @param string $a5_bkup_bill_agreement_id Unique ID of the secondary bill agreement.
     * @param string $a5_bkup_cvv Card Verification Value, used to help verify a transaction is being requested by the secondary card holder since this value is physically printed on the credit card.
     * @param string $a5_seq_func_group_id Unique Functional account group id specifically designated for statement sequence number assignment.
     * @param int $a5_revrec_profile_id Profile ID of an existing Revenue Recognition Profile.
     * @param string $a5_revrec_client_defined_id Client Defined Identifier of an existing Revenue Recognition Profile.  If this  parameter is specified it will take precedence over revrec_profile_id.
    ...
    public function create_acct_hierarchy($do_write = null, $client_receipt_id = null, $a1_alt_start_date = null, $a1_client_acct_id = null, $a1_userid = null, $a1_status_cd = null, $a1_master_plan_no = null, $a1_master_plan_units = null, $a1_supp_plans = null, $a1_supp_plan_units = null, $a1_notify_method = null, $a1_promo_cd = null, $a1_password = null, $a1_secret_question = null, $a1_secret_question_answer = null, $a1_first_name = null, $a1_mi = null, $a1_last_name = null, $a1_company_name = null, $a1_address1 = null, $a1_address2 = null, $a1_city = null, $a1_locality = null, $a1_state_prov = null, $a1_country = null, $a1_postal_cd = null, $a1_phone = null, $a1_phone_ext = null, $a1_cell_phone = null, $a1_work_phone = null, $a1_work_phone_ext = null, $a1_email = null, $a1_birthdate = null, $a1_bill_first_name = null, $a1_bill_mi = null, $a1_bill_last_name = null, $a1_bill_company_name = null, $a1_bill_address1 = null, $a1_bill_address2 = null, $a1_bill_city = null, $a1_bill_locality = null, $a1_bill_state_prov = null, $a1_bill_country = null, $a1_bill_postal_cd = null, $a1_bill_phone = null, $a1_bill_phone_ext = null, $a1_bill_cell_phone = null, $a1_bill_work_phone = null, $a1_bill_work_phone_ext = null, $a1_bill_email = null, $a1_pay_method = null, $a1_cc_number = null, $a1_cc_expire_mm = null, $a1_cc_expire_yyyy = null, $a1_bank_acct_no = null, $a1_bank_routing_no = null, $a1_resp_level_cd = null, $a1_functional_acct_groups = null, $a1_collections_acct_groups = null, $a1_supp_field_names = null, $a1_supp_field_values = null, $a1_test_acct_ind = null, $a1_status_until_alt_start = null, $a1_balance_forward = null, $a1_alt_bill_day = null, $a1_do_full_invoicing = null, $a1_do_prorated_invoicing = null, $a1_master_plan_alt_rate_sched_no = null, $a1_supp_plan_alt_rate_sched_no = null, $a1_currency_cd = null, $a1_cvv = null, $a1_taxpayer_id = null, $a1_bill_agreement_id = null, $a1_retroactive_start_date = null, $a1_coupon_codes = null, $a1_new_acct_custom_rates = null, $a1_alt_msg_template_no = null, $a1_seq_func_group_no = null, $a1_new_acct_plan_contracts = null, $a1_address3 = null, $a1_bill_address3 = null, $a1_usage_accumulation_config = null, $a1_enable_usage_pooling_plan_no = null, $a1_client_func_acct_group_ids = null, $a1_client_coll_acct_group_ids = null, $a1_track_data1 = null, $a1_track_data2 = null, $a1_tax_exemption_level = null, $a1_cn_alt_msg_template_no = null, $a1_invoice_approval_required = null, $a1_create_session = null, $a1_client_master_plan_id = null, $a1_client_supp_plan_ids = null, $a1_client_mp_alt_rate_sched_id = null, $a1_client_sp_alt_rate_sched_ids = null, $a1_client_alt_msg_template_id = null, $a1_client_cn_alt_msg_template_no = null, $a1_iban = null, $a1_bank_check_digit = null, $a1_bank_swift_cd = null, $a1_bank_country_cd = null, $a1_mandate_id = null, $a1_bank_id_cd = null, $a1_bank_branch_cd = null, $a1_surcharge_no = null, $a1_bkup_bill_first_name = null, $a1_bkup_bill_mi = null, $a1_bkup_bill_last_name = null, $a1_bkup_bill_company_name = null, $a1_bkup_bill_address1 = null, $a1_bkup_bill_address2 = null, $a1_bkup_bill_address3 = null, $a1_bkup_bill_city = null, $a1_bkup_bill_locality = null, $a1_bkup_bill_state_prov = null, $a1_bkup_bill_country = null, $a1_bkup_bill_postal_cd = null, $a1_bkup_bill_phone = null, $a1_bkup_bill_phone_ext = null, $a1_bkup_bill_cell_phone = null, $a1_bkup_bill_work_phone = null, $a1_bkup_bill_work_phone_ext = null, $a1_bkup_bill_email = null, $a1_bkup_pay_method = null, $a1_bkup_cc_number = null, $a1_bkup_cc_expire_mm = null, $a1_bkup_cc_expire_yyyy = null, $a1_bkup_bank_acct_no = null, $a1_bkup_bank_routing_no = null, $a1_bkup_bill_agreement_id = null, $a1_bkup_cvv = null, $a1_seq_func_group_id = null, $a1_revrec_profile_id = null, $a1_revrec_client_defined_id = null, $a2_alt_start_date = null, $a2_client_acct_id = null, $a2_userid = null, $a2_status_cd = null, $a2_master_plan_no = null, $a2_master_plan_units = null, $a2_supp_plans = null, $a2_supp_plan_units = null, $a2_notify_method = null, $a2_promo_cd = null, $a2_password = null, $a2_secret_question = null, $a2_secret_question_answer = null, $a2_first_name = null, $a2_mi = null, $a2_last_name = null, $a2_company_name = null, $a2_address1 = null, $a2_address2 = null, $a2_city = null, $a2_locality = null, $a2_state_prov = null, $a2_country = null, $a2_postal_cd = null, $a2_phone = null, $a2_phone_ext = null, $a2_cell_phone = null, $a2_work_phone = null, $a2_work_phone_ext = null, $a2_email = null, $a2_birthdate = null, $a2_bill_first_name = null, $a2_bill_mi = null, $a2_bill_last_name = null, $a2_bill_company_name = null, $a2_bill_address1 = null, $a2_bill_address2 = null, $a2_bill_city = null, $a2_bill_locality = null, $a2_bill_state_prov = null, $a2_bill_country = null, $a2_bill_postal_cd = null, $a2_bill_phone = null, $a2_bill_phone_ext = null, $a2_bill_cell_phone = null, $a2_bill_work_phone = null, $a2_bill_work_phone_ext = null, $a2_bill_email = null, $a2_pay_method = null, $a2_cc_number = null, $a2_cc_expire_mm = null, $a2_cc_expire_yyyy = null, $a2_bank_acct_no = null, $a2_bank_routing_no = null, $a2_resp_level_cd = null, $a2_functional_acct_groups = null, $a2_collections_acct_groups = null, $a2_supp_field_names = null, $a2_supp_field_values = null, $a2_test_acct_ind = null, $a2_status_until_alt_start = null, $a2_balance_forward = null, $a2_alt_bill_day = null, $a2_do_full_invoicing = null, $a2_do_prorated_invoicing = null, $a2_master_plan_alt_rate_sched_no = null, $a2_supp_plan_alt_rate_sched_no = null, $a2_currency_cd = null, $a2_cvv = null, $a2_taxpayer_id = null, $a2_bill_agreement_id = null, $a2_retroactive_start_date = null, $a2_coupon_codes = null, $a2_new_acct_custom_rates = null, $a2_alt_msg_template_no = null, $a2_seq_func_group_no = null, $a2_new_acct_plan_contracts = null, $a2_address3 = null, $a2_bill_address3 = null, $a2_usage_accumulation_config = null, $a2_enable_usage_pooling_plan_no = null, $a2_client_func_acct_group_ids = null, $a2_client_coll_acct_group_ids = null, $a2_track_data1 = null, $a2_track_data2 = null, $a2_tax_exemption_level = null, $a2_cn_alt_msg_template_no = null, $a2_invoice_approval_required = null, $a2_create_session = null, $a2_client_master_plan_id = null, $a2_client_supp_plan_ids = null, $a2_client_mp_alt_rate_sched_id = null, $a2_client_sp_alt_rate_sched_ids = null, $a2_client_alt_msg_template_id = null, $a2_client_cn_alt_msg_template_no = null, $a2_iban = null, $a2_bank_check_digit = null, $a2_bank_swift_cd = null, $a2_bank_country_cd = null, $a2_mandate_id = null, $a2_bank_id_cd = null, $a2_bank_branch_cd = null, $a2_surcharge_no = null, $a2_bkup_bill_first_name = null, $a2_bkup_bill_mi = null, $a2_bkup_bill_last_name = null, $a2_bkup_bill_company_name = null, $a2_bkup_bill_address1 = null, $a2_bkup_bill_address2 = null, $a2_bkup_bill_address3 = null, $a2_bkup_bill_city = null, $a2_bkup_bill_locality = null, $a2_bkup_bill_state_prov = null, $a2_bkup_bill_country = null, $a2_bkup_bill_postal_cd = null, $a2_bkup_bill_phone = null, $a2_bkup_bill_phone_ext = null, $a2_bkup_bill_cell_phone = null, $a2_bkup_bill_work_phone = null, $a2_bkup_bill_work_phone_ext = null, $a2_bkup_bill_email = null, $a2_bkup_pay_method = null, $a2_bkup_cc_number = null, $a2_bkup_cc_expire_mm = null, $a2_bkup_cc_expire_yyyy = null, $a2_bkup_bank_acct_no = null, $a2_bkup_bank_routing_no = null, $a2_bkup_bill_agreement_id = null, $a2_bkup_cvv = null, $a2_seq_func_group_id = null, $a2_revrec_profile_id = null, $a2_revrec_client_defined_id = null, $a3_alt_start_date = null, $a3_client_acct_id = null, $a3_userid = null, $a3_status_cd = null, $a3_master_plan_no = null, $a3_master_plan_units = null, $a3_supp_plans = null, $a3_supp_plan_units = null, $a3_notify_method = null, $a3_promo_cd = null, $a3_password = null, $a3_secret_question = null, $a3_secret_question_answer = null, $a3_first_name = null, $a3_mi = null, $a3_last_name = null, $a3_company_name = null, $a3_address1 = null, $a3_address2 = null, $a3_city = null, $a3_locality = null, $a3_state_prov = null, $a3_country = null, $a3_postal_cd = null, $a3_phone = null, $a3_phone_ext = null, $a3_cell_phone = null, $a3_work_phone = null, $a3_work_phone_ext = null, $a3_email = null, $a3_birthdate = null, $a3_bill_first_name = null, $a3_bill_mi = null, $a3_bill_last_name = null, $a3_bill_company_name = null, $a3_bill_address1 = null, $a3_bill_address2 = null, $a3_bill_city = null, $a3_bill_locality = null, $a3_bill_state_prov = null, $a3_bill_country = null, $a3_bill_postal_cd = null, $a3_bill_phone = null, $a3_bill_phone_ext = null, $a3_bill_cell_phone = null, $a3_bill_work_phone = null, $a3_bill_work_phone_ext = null, $a3_bill_email = null, $a3_pay_method = null, $a3_cc_number = null, $a3_cc_expire_mm = null, $a3_cc_expire_yyyy = null, $a3_bank_acct_no = null, $a3_bank_routing_no = null, $a3_resp_level_cd = null, $a3_functional_acct_groups = null, $a3_collections_acct_groups = null, $a3_supp_field_names = null, $a3_supp_field_values = null, $a3_test_acct_ind = null, $a3_status_until_alt_start = null, $a3_balance_forward = null, $a3_alt_bill_day = null, $a3_do_full_invoicing = null, $a3_do_prorated_invoicing = null, $a3_master_plan_alt_rate_sched_no = null, $a3_supp_plan_alt_rate_sched_no = null, $a3_currency_cd = null, $a3_cvv = null, $a3_taxpayer_id = null, $a3_bill_agreement_id = null, $a3_retroactive_start_date = null, $a3_coupon_codes = null, $a3_new_acct_custom_rates = null, $a3_alt_msg_template_no = null, $a3_seq_func_group_no = null, $a3_new_acct_plan_contracts = null, $a3_address3 = null, $a3_bill_address3 = null, $a3_usage_accumulation_config = null, $a3_enable_usage_pooling_plan_no = null, $a3_client_func_acct_group_ids = null, $a3_client_coll_acct_group_ids = null, $a3_track_data1 = null, $a3_track_data2 = null, $a3_tax_exemption_level = null, $a3_cn_alt_msg_template_no = null, $a3_invoice_approval_required = null, $a3_create_session = null, $a3_client_master_plan_id = null, $a3_client_supp_plan_ids = null, $a3_client_mp_alt_rate_sched_id = null, $a3_client_sp_alt_rate_sched_ids = null, $a3_client_alt_msg_template_id = null, $a3_client_cn_alt_msg_template_no = null, $a3_iban = null, $a3_bank_check_digit = null, $a3_bank_swift_cd = null, $a3_bank_country_cd = null, $a3_mandate_id = null, $a3_bank_id_cd = null, $a3_bank_branch_cd = null, $a3_surcharge_no = null, $a3_bkup_bill_first_name = null, $a3_bkup_bill_mi = null, $a3_bkup_bill_last_name = null, $a3_bkup_bill_company_name = null, $a3_bkup_bill_address1 = null, $a3_bkup_bill_address2 = null, $a3_bkup_bill_address3 = null, $a3_bkup_bill_city = null, $a3_bkup_bill_locality = null, $a3_bkup_bill_state_prov = null, $a3_bkup_bill_country = null, $a3_bkup_bill_postal_cd = null, $a3_bkup_bill_phone = null, $a3_bkup_bill_phone_ext = null, $a3_bkup_bill_cell_phone = null, $a3_bkup_bill_work_phone = null, $a3_bkup_bill_work_phone_ext = null, $a3_bkup_bill_email = null, $a3_bkup_pay_method = null, $a3_bkup_cc_number = null, $a3_bkup_cc_expire_mm = null, $a3_bkup_cc_expire_yyyy = null, $a3_bkup_bank_acct_no = null, $a3_bkup_bank_routing_no = null, $a3_bkup_bill_agreement_id = null, $a3_bkup_cvv = null, $a3_seq_func_group_id = null, $a3_revrec_profile_id = null, $a3_revrec_client_defined_id = null, $a4_alt_start_date = null, $a4_client_acct_id = null, $a4_userid = null, $a4_status_cd = null, $a4_master_plan_no = null, $a4_master_plan_units = null, $a4_supp_plans = null, $a4_supp_plan_units = null, $a4_notify_method = null, $a4_promo_cd = null, $a4_password = null, $a4_secret_question = null, $a4_secret_question_answer = null, $a4_first_name = null, $a4_mi = null, $a4_last_name = null, $a4_company_name = null, $a4_address1 = null, $a4_address2 = null, $a4_city = null, $a4_locality = null, $a4_state_prov = null, $a4_country = null, $a4_postal_cd = null, $a4_phone = null, $a4_phone_ext = null, $a4_cell_phone = null, $a4_work_phone = null, $a4_work_phone_ext = null, $a4_email = null, $a4_birthdate = null, $a4_bill_first_name = null, $a4_bill_mi = null, $a4_bill_last_name = null, $a4_bill_company_name = null, $a4_bill_address1 = null, $a4_bill_address2 = null, $a4_bill_city = null, $a4_bill_locality = null, $a4_bill_state_prov = null, $a4_bill_country = null, $a4_bill_postal_cd = null, $a4_bill_phone = null, $a4_bill_phone_ext = null, $a4_bill_cell_phone = null, $a4_bill_work_phone = null, $a4_bill_work_phone_ext = null, $a4_bill_email = null, $a4_pay_method = null, $a4_cc_number = null, $a4_cc_expire_mm = null, $a4_cc_expire_yyyy = null, $a4_bank_acct_no = null, $a4_bank_routing_no = null, $a4_resp_level_cd = null, $a4_functional_acct_groups = null, $a4_collections_acct_groups = null, $a4_supp_field_names = null, $a4_supp_field_values = null, $a4_test_acct_ind = null, $a4_status_until_alt_start = null, $a4_balance_forward = null, $a4_alt_bill_day = null, $a4_do_full_invoicing = null, $a4_do_prorated_invoicing = null, $a4_master_plan_alt_rate_sched_no = null, $a4_supp_plan_alt_rate_sched_no = null, $a4_currency_cd = null, $a4_cvv = null, $a4_taxpayer_id = null, $a4_bill_agreement_id = null, $a4_retroactive_start_date = null, $a4_coupon_codes = null, $a4_new_acct_custom_rates = null, $a4_alt_msg_template_no = null, $a4_seq_func_group_no = null, $a4_new_acct_plan_contracts = null, $a4_address3 = null, $a4_bill_address3 = null, $a4_usage_accumulation_config = null, $a4_enable_usage_pooling_plan_no = null, $a4_client_func_acct_group_ids = null, $a4_client_coll_acct_group_ids = null, $a4_track_data1 = null, $a4_track_data2 = null, $a4_tax_exemption_level = null, $a4_cn_alt_msg_template_no = null, $a4_invoice_approval_required = null, $a4_create_session = null, $a4_client_master_plan_id = null, $a4_client_supp_plan_ids = null, $a4_client_mp_alt_rate_sched_id = null, $a4_client_sp_alt_rate_sched_ids = null, $a4_client_alt_msg_template_id = null, $a4_client_cn_alt_msg_template_no = null, $a4_iban = null, $a4_bank_check_digit = null, $a4_bank_swift_cd = null, $a4_bank_country_cd = null, $a4_mandate_id = null, $a4_bank_id_cd = null, $a4_bank_branch_cd = null, $a4_surcharge_no = null, $a4_bkup_bill_first_name = null, $a4_bkup_bill_mi = null, $a4_bkup_bill_last_name = null, $a4_bkup_bill_company_name = null, $a4_bkup_bill_address1 = null, $a4_bkup_bill_address2 = null, $a4_bkup_bill_address3 = null, $a4_bkup_bill_city = null, $a4_bkup_bill_locality = null, $a4_bkup_bill_state_prov = null, $a4_bkup_bill_country = null, $a4_bkup_bill_postal_cd = null, $a4_bkup_bill_phone = null, $a4_bkup_bill_phone_ext = null, $a4_bkup_bill_cell_phone = null, $a4_bkup_bill_work_phone = null, $a4_bkup_bill_work_phone_ext = null, $a4_bkup_bill_email = null, $a4_bkup_pay_method = null, $a4_bkup_cc_number = null, $a4_bkup_cc_expire_mm = null, $a4_bkup_cc_expire_yyyy = null, $a4_bkup_bank_acct_no = null, $a4_bkup_bank_routing_no = null, $a4_bkup_bill_agreement_id = null, $a4_bkup_cvv = null, $a4_seq_func_group_id = null, $a4_revrec_profile_id = null, $a4_revrec_client_defined_id = null, $a5_alt_start_date = null, $a5_client_acct_id = null, $a5_userid = null, $a5_status_cd = null, $a5_master_plan_no = null, $a5_master_plan_units = null, $a5_supp_plans = null, $a5_supp_plan_units = null, $a5_notify_method = null, $a5_promo_cd = null, $a5_password = null, $a5_secret_question = null, $a5_secret_question_answer = null, $a5_first_name = null, $a5_mi = null, $a5_last_name = null, $a5_company_name = null, $a5_address1 = null, $a5_address2 = null, $a5_city = null, $a5_locality = null, $a5_state_prov = null, $a5_country = null, $a5_postal_cd = null, $a5_phone = null, $a5_phone_ext = null, $a5_cell_phone = null, $a5_work_phone = null, $a5_work_phone_ext = null, $a5_email = null, $a5_birthdate = null, $a5_bill_first_name = null, $a5_bill_mi = null, $a5_bill_last_name = null, $a5_bill_company_name = null, $a5_bill_address1 = null, $a5_bill_address2 = null, $a5_bill_city = null, $a5_bill_locality = null, $a5_bill_state_prov = null, $a5_bill_country = null, $a5_bill_postal_cd = null, $a5_bill_phone = null, $a5_bill_phone_ext = null, $a5_bill_cell_phone = null, $a5_bill_work_phone = null, $a5_bill_work_phone_ext = null, $a5_bill_email = null, $a5_pay_method = null, $a5_cc_number = null, $a5_cc_expire_mm = null, $a5_cc_expire_yyyy = null, $a5_bank_acct_no = null, $a5_bank_routing_no = null, $a5_resp_level_cd = null, $a5_functional_acct_groups = null, $a5_collections_acct_groups = null, $a5_supp_field_names = null, $a5_supp_field_values = null, $a5_test_acct_ind = null, $a5_status_until_alt_start = null, $a5_balance_forward = null, $a5_alt_bill_day = null, $a5_do_full_invoicing = null, $a5_do_prorated_invoicing = null, $a5_master_plan_alt_rate_sched_no = null, $a5_supp_plan_alt_rate_sched_no = null, $a5_currency_cd = null, $a5_cvv = null, $a5_taxpayer_id = null, $a5_bill_agreement_id = null, $a5_retroactive_start_date = null, $a5_coupon_codes = null, $a5_new_acct_custom_rates = null, $a5_alt_msg_template_no = null, $a5_seq_func_group_no = null, $a5_new_acct_plan_contracts = null, $a5_address3 = null, $a5_bill_address3 = null, $a5_usage_accumulation_config = null, $a5_enable_usage_pooling_plan_no = null, $a5_client_func_acct_group_ids = null, $a5_client_coll_acct_group_ids = null, $a5_track_data1 = null, $a5_track_data2 = null, $a5_tax_exemption_level = null, $a5_cn_alt_msg_template_no = null, $a5_invoice_approval_required = null, $a5_create_session = null, $a5_client_master_plan_id = null, $a5_client_supp_plan_ids = null, $a5_client_mp_alt_rate_sched_id = null, $a5_client_sp_alt_rate_sched_ids = null, $a5_client_alt_msg_template_id = null, $a5_client_cn_alt_msg_template_no = null, $a5_iban = null, $a5_bank_check_digit = null, $a5_bank_swift_cd = null, $a5_bank_country_cd = null, $a5_mandate_id = null, $a5_bank_id_cd = null, $a5_bank_branch_cd = null, $a5_surcharge_no = null, $a5_bkup_bill_first_name = null, $a5_bkup_bill_mi = null, $a5_bkup_bill_last_name = null, $a5_bkup_bill_company_name = null, $a5_bkup_bill_address1 = null, $a5_bkup_bill_address2 = null, $a5_bkup_bill_address3 = null, $a5_bkup_bill_city = null, $a5_bkup_bill_locality = null, $a5_bkup_bill_state_prov = null, $a5_bkup_bill_country = null, $a5_bkup_bill_postal_cd = null, $a5_bkup_bill_phone = null, $a5_bkup_bill_phone_ext = null, $a5_bkup_bill_cell_phone = null, $a5_bkup_bill_work_phone = null, $a5_bkup_bill_work_phone_ext = null, $a5_bkup_bill_email = null, $a5_bkup_pay_method = null, $a5_bkup_cc_number = null, $a5_bkup_cc_expire_mm = null, $a5_bkup_cc_expire_yyyy = null, $a5_bkup_bank_acct_no = null, $a5_bkup_bank_routing_no = null, $a5_bkup_bill_agreement_id = null, $a5_bkup_cvv = null, $a5_seq_func_group_id = null, $a5_revrec_profile_id = null, $a5_revrec_client_defined_id = null)
    {
        return $this->__ws_call('create_acct_hierarchy', Array(
                ...
                'a1_bkup_bill_first_name' => $a1_bkup_bill_first_name,
                'a1_bkup_bill_mi' => $a1_bkup_bill_mi,
                'a1_bkup_bill_last_name' => $a1_bkup_bill_last_name,
                'a1_bkup_bill_company_name' => $a1_bkup_bill_company_name,
                'a1_bkup_bill_address1' => $a1_bkup_bill_address1,
                'a1_bkup_bill_address2' => $a1_bkup_bill_address2,
                'a1_bkup_bill_address3' => $a1_bkup_bill_address3,
                'a1_bkup_bill_city' => $a1_bkup_bill_city,
                'a1_bkup_bill_locality' => $a1_bkup_bill_locality,
                'a1_bkup_bill_state_prov' => $a1_bkup_bill_state_prov,
                'a1_bkup_bill_country' => $a1_bkup_bill_country,
                'a1_bkup_bill_postal_cd' => $a1_bkup_bill_postal_cd,
                'a1_bkup_bill_phone' => $a1_bkup_bill_phone,
                'a1_bkup_bill_phone_ext' => $a1_bkup_bill_phone_ext,
                'a1_bkup_bill_cell_phone' => $a1_bkup_bill_cell_phone,
                'a1_bkup_bill_work_phone' => $a1_bkup_bill_work_phone,
                'a1_bkup_bill_work_phone_ext' => $a1_bkup_bill_work_phone_ext,
                'a1_bkup_bill_email' => $a1_bkup_bill_email,
                'a1_bkup_pay_method' => $a1_bkup_pay_method,
                'a1_bkup_cc_number' => $a1_bkup_cc_number,
                'a1_bkup_cc_expire_mm' => $a1_bkup_cc_expire_mm,
                'a1_bkup_cc_expire_yyyy' => $a1_bkup_cc_expire_yyyy,
                'a1_bkup_bank_acct_no' => $a1_bkup_bank_acct_no,
                'a1_bkup_bank_routing_no' => $a1_bkup_bank_routing_no,
                'a1_bkup_bill_agreement_id' => $a1_bkup_bill_agreement_id,
                'a1_bkup_cvv' => $a1_bkup_cvv,
                'a1_seq_func_group_id' => $a1_seq_func_group_id,
                'a1_revrec_profile_id' => $a1_revrec_profile_id,
                'a1_revrec_client_defined_id' => $a1_revrec_client_defined_id,
                ...
                'a2_bkup_bill_first_name' => $a2_bkup_bill_first_name,
                'a2_bkup_bill_mi' => $a2_bkup_bill_mi,
                'a2_bkup_bill_last_name' => $a2_bkup_bill_last_name,
                'a2_bkup_bill_company_name' => $a2_bkup_bill_company_name,
                'a2_bkup_bill_address1' => $a2_bkup_bill_address1,
                'a2_bkup_bill_address2' => $a2_bkup_bill_address2,
                'a2_bkup_bill_address3' => $a2_bkup_bill_address3,
                'a2_bkup_bill_city' => $a2_bkup_bill_city,
                'a2_bkup_bill_locality' => $a2_bkup_bill_locality,
                'a2_bkup_bill_state_prov' => $a2_bkup_bill_state_prov,
                'a2_bkup_bill_country' => $a2_bkup_bill_country,
                'a2_bkup_bill_postal_cd' => $a2_bkup_bill_postal_cd,
                'a2_bkup_bill_phone' => $a2_bkup_bill_phone,
                'a2_bkup_bill_phone_ext' => $a2_bkup_bill_phone_ext,
                'a2_bkup_bill_cell_phone' => $a2_bkup_bill_cell_phone,
                'a2_bkup_bill_work_phone' => $a2_bkup_bill_work_phone,
                'a2_bkup_bill_work_phone_ext' => $a2_bkup_bill_work_phone_ext,
                'a2_bkup_bill_email' => $a2_bkup_bill_email,
                'a2_bkup_pay_method' => $a2_bkup_pay_method,
                'a2_bkup_cc_number' => $a2_bkup_cc_number,
                'a2_bkup_cc_expire_mm' => $a2_bkup_cc_expire_mm,
                'a2_bkup_cc_expire_yyyy' => $a2_bkup_cc_expire_yyyy,
                'a2_bkup_bank_acct_no' => $a2_bkup_bank_acct_no,
                'a2_bkup_bank_routing_no' => $a2_bkup_bank_routing_no,
                'a2_bkup_bill_agreement_id' => $a2_bkup_bill_agreement_id,
                'a2_bkup_cvv' => $a2_bkup_cvv,
                'a2_seq_func_group_id' => $a2_seq_func_group_id,
                'a2_revrec_profile_id' => $a2_revrec_profile_id,
                'a2_revrec_client_defined_id' => $a2_revrec_client_defined_id,
                ...
                'a3_bkup_bill_first_name' => $a3_bkup_bill_first_name,
                'a3_bkup_bill_mi' => $a3_bkup_bill_mi,
                'a3_bkup_bill_last_name' => $a3_bkup_bill_last_name,
                'a3_bkup_bill_company_name' => $a3_bkup_bill_company_name,
                'a3_bkup_bill_address1' => $a3_bkup_bill_address1,
                'a3_bkup_bill_address2' => $a3_bkup_bill_address2,
                'a3_bkup_bill_address3' => $a3_bkup_bill_address3,
                'a3_bkup_bill_city' => $a3_bkup_bill_city,
                'a3_bkup_bill_locality' => $a3_bkup_bill_locality,
                'a3_bkup_bill_state_prov' => $a3_bkup_bill_state_prov,
                'a3_bkup_bill_country' => $a3_bkup_bill_country,
                'a3_bkup_bill_postal_cd' => $a3_bkup_bill_postal_cd,
                'a3_bkup_bill_phone' => $a3_bkup_bill_phone,
                'a3_bkup_bill_phone_ext' => $a3_bkup_bill_phone_ext,
                'a3_bkup_bill_cell_phone' => $a3_bkup_bill_cell_phone,
                'a3_bkup_bill_work_phone' => $a3_bkup_bill_work_phone,
                'a3_bkup_bill_work_phone_ext' => $a3_bkup_bill_work_phone_ext,
                'a3_bkup_bill_email' => $a3_bkup_bill_email,
                'a3_bkup_pay_method' => $a3_bkup_pay_method,
                'a3_bkup_cc_number' => $a3_bkup_cc_number,
                'a3_bkup_cc_expire_mm' => $a3_bkup_cc_expire_mm,
                'a3_bkup_cc_expire_yyyy' => $a3_bkup_cc_expire_yyyy,
                'a3_bkup_bank_acct_no' => $a3_bkup_bank_acct_no,
                'a3_bkup_bank_routing_no' => $a3_bkup_bank_routing_no,
                'a3_bkup_bill_agreement_id' => $a3_bkup_bill_agreement_id,
                'a3_bkup_cvv' => $a3_bkup_cvv,
                'a3_seq_func_group_id' => $a3_seq_func_group_id,
                'a3_revrec_profile_id' => $a3_revrec_profile_id,
                'a3_revrec_client_defined_id' => $a3_revrec_client_defined_id,
                ...
                'a4_bkup_bill_first_name' => $a4_bkup_bill_first_name,
                'a4_bkup_bill_mi' => $a4_bkup_bill_mi,
                'a4_bkup_bill_last_name' => $a4_bkup_bill_last_name,
                'a4_bkup_bill_company_name' => $a4_bkup_bill_company_name,
                'a4_bkup_bill_address1' => $a4_bkup_bill_address1,
                'a4_bkup_bill_address2' => $a4_bkup_bill_address2,
                'a4_bkup_bill_address3' => $a4_bkup_bill_address3,
                'a4_bkup_bill_city' => $a4_bkup_bill_city,
                'a4_bkup_bill_locality' => $a4_bkup_bill_locality,
                'a4_bkup_bill_state_prov' => $a4_bkup_bill_state_prov,
                'a4_bkup_bill_country' => $a4_bkup_bill_country,
                'a4_bkup_bill_postal_cd' => $a4_bkup_bill_postal_cd,
                'a4_bkup_bill_phone' => $a4_bkup_bill_phone,
                'a4_bkup_bill_phone_ext' => $a4_bkup_bill_phone_ext,
                'a4_bkup_bill_cell_phone' => $a4_bkup_bill_cell_phone,
                'a4_bkup_bill_work_phone' => $a4_bkup_bill_work_phone,
                'a4_bkup_bill_work_phone_ext' => $a4_bkup_bill_work_phone_ext,
                'a4_bkup_bill_email' => $a4_bkup_bill_email,
                'a4_bkup_pay_method' => $a4_bkup_pay_method,
                'a4_bkup_cc_number' => $a4_bkup_cc_number,
                'a4_bkup_cc_expire_mm' => $a4_bkup_cc_expire_mm,
                'a4_bkup_cc_expire_yyyy' => $a4_bkup_cc_expire_yyyy,
                'a4_bkup_bank_acct_no' => $a4_bkup_bank_acct_no,
                'a4_bkup_bank_routing_no' => $a4_bkup_bank_routing_no,
                'a4_bkup_bill_agreement_id' => $a4_bkup_bill_agreement_id,
                'a4_bkup_cvv' => $a4_bkup_cvv,
                'a4_seq_func_group_id' => $a4_seq_func_group_id,
                'a4_revrec_profile_id' => $a4_revrec_profile_id,
                'a4_revrec_client_defined_id' => $a4_revrec_client_defined_id,
                ...
                'a5_bkup_bill_first_name' => $a5_bkup_bill_first_name,
                'a5_bkup_bill_mi' => $a5_bkup_bill_mi,
                'a5_bkup_bill_last_name' => $a5_bkup_bill_last_name,
                'a5_bkup_bill_company_name' => $a5_bkup_bill_company_name,
                'a5_bkup_bill_address1' => $a5_bkup_bill_address1,
                'a5_bkup_bill_address2' => $a5_bkup_bill_address2,
                'a5_bkup_bill_address3' => $a5_bkup_bill_address3,
                'a5_bkup_bill_city' => $a5_bkup_bill_city,
                'a5_bkup_bill_locality' => $a5_bkup_bill_locality,
                'a5_bkup_bill_state_prov' => $a5_bkup_bill_state_prov,
                'a5_bkup_bill_country' => $a5_bkup_bill_country,
                'a5_bkup_bill_postal_cd' => $a5_bkup_bill_postal_cd,
                'a5_bkup_bill_phone' => $a5_bkup_bill_phone,
                'a5_bkup_bill_phone_ext' => $a5_bkup_bill_phone_ext,
                'a5_bkup_bill_cell_phone' => $a5_bkup_bill_cell_phone,
                'a5_bkup_bill_work_phone' => $a5_bkup_bill_work_phone,
                'a5_bkup_bill_work_phone_ext' => $a5_bkup_bill_work_phone_ext,
                'a5_bkup_bill_email' => $a5_bkup_bill_email,
                'a5_bkup_pay_method' => $a5_bkup_pay_method,
                'a5_bkup_cc_number' => $a5_bkup_cc_number,
                'a5_bkup_cc_expire_mm' => $a5_bkup_cc_expire_mm,
                'a5_bkup_cc_expire_yyyy' => $a5_bkup_cc_expire_yyyy,
                'a5_bkup_bank_acct_no' => $a5_bkup_bank_acct_no,
                'a5_bkup_bank_routing_no' => $a5_bkup_bank_routing_no,
                'a5_bkup_bill_agreement_id' => $a5_bkup_bill_agreement_id,
                'a5_bkup_cvv' => $a5_bkup_cvv,
                'a5_seq_func_group_id' => $a5_seq_func_group_id,
                'a5_revrec_profile_id' => $a5_revrec_profile_id,
                'a5_revrec_client_defined_id' => $a5_revrec_client_defined_id
        ));
    }
     ...
     * @param int $transaction_id Aria assigned unique number to identify and invoicing activity.
     * @param int $invoice_no Aria assigned unique number for a given invoice.
     * @param int $invoice_line_item Line number appearing within an invoice.
     ...
     */
    public function get_usage_history($acct_no, $specified_usage_type_no = null, $date_range_start = null, $date_range_end = null, $specified_usage_type_code = null, $usage_qualifier_1 = null, $usage_qualifier_2 = null, $usage_qualifier_3 = null, $usage_qualifier_4 = null, $limit = null, $offset = null, $transaction_id = null, $invoice_no = null, $invoice_line_item = null)
    {
     ...
     * @param int $acct_no Aria assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param int $primary_or_bkup_pay_mthd_ind Indicates whether to remove primary or secondary payment method.
     * @return mixed[] int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function remove_pay_method($acct_no, $primary_or_bkup_pay_mthd_ind = null)
    {
        return $this->__ws_call('remove_pay_method', Array(
                'acct_no' => $acct_no,
                'primary_or_bkup_pay_mthd_ind' => $primary_or_bkup_pay_mthd_ind
        ));
    }
     ...
     * @param string $effective_date If the assignment directive is for future date assignment, this is the effective date for that assignment
     * @param int $sync_mstr_bill_dates_override Overrides the client-level setting that determines whether or not master plan billing dates should be reset when assigning a new supplemental plan. If this value is left empty, the client-level setting will take effect.
     * @param array $supp_plan_surcharges 
     ...
     */
    public function assign_supp_plan_multi($acct_no, $supp_plans_to_assign, $assignment_directive = null, $do_write = null, $comments = null, $client_receipt_id = null, $alt_proration_start_date = null, $coupon_codes = null, $effective_date = null, $sync_mstr_bill_dates_override = null, $supp_plan_surcharges = null)
    {
        return $this->__ws_call('assign_supp_plan_multi', Array(
                ...
                'effective_date' => $effective_date,
                'sync_mstr_bill_dates_override' => $sync_mstr_bill_dates_override,
                'supp_plan_surcharges' => $supp_plan_surcharges
        ));
    }
     ...
     * @return mixed[] int statement_no The unique statement number.<br>string seq_statement_id The unique sequential statement number.<br>int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param array $usage_unit_thresholds 
     * @return mixed[] int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function set_acct_usg_mtd_threshold($acct_no, $amount = null, $usage_unit_thresholds = null)
    {
        return $this->__ws_call('set_acct_usg_mtd_threshold', Array(
                'acct_no' => $acct_no,
                'amount' => $amount,
                'usage_unit_thresholds' => $usage_unit_thresholds
        ));
    }
     ...
     * @return mixed[] int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function set_acct_usg_ptd_threshold($acct_no, $amount = null, $usage_unit_thresholds = null)
    {
     ...
     * @return mixed[] int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function set_client_usg_mtd_threshold($acct_no, $amount = null, $usage_unit_thresholds = null)
    {
     ...
     * @return mixed[] int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function set_client_usg_ptd_threshold($acct_no, $amount = null, $usage_unit_thresholds = null)
    {
     ...
     * @param array $usage_qualifier_3 
     * @param array $usage_qualifier_4 
     * @param string $usage_type_cd_filter The client assigned usage type code used to search for usage history records.
     ...
     * @param int $acct_no Aria assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] int error_code Aria assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>double total_amount The total amount of all the open charges<br>array open_charge_items Array of open charge line items.
     */
    public function get_acct_open_charges($acct_no)
    {
        return $this->__ws_call('get_acct_open_charges', Array(
                'acct_no' => $acct_no
        ));
    }
     ...
     * @param string $bank_id_cd Up to 10 digit numeric bank identifier code. Used for the Direct Debit payment method. Used in Europe.  Only hyphen and space are allowed to format the bank id code. It is required for BBAN.
     * @param string $bank_branch_cd Up to 10 digit numeric bank branch code. Used for the Direct Debit payment method. Used in Europe.  Only hyphen and space are allowed to format the bank branch code.
     * @param string $statement_message Alternate contact details for orders.
     * @param string $fulfilled_date Date on which order is fulfilled.
     ...
     * @param string $client_order_id This is the client-assigned order identifier.
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions nullable: true
     * @param string $statement_message Alternate contact details for orders.
     ...
     */
    public function record_standing_order($account_no, $billing_interval_units, $times_to_bill, $billing_interval_type = null, $first_bill_date = null, $standing_order = null, $client_order_id = null, $client_receipt_id = null, $statement_message = null)
    {
     ...
     */
    public function bulk_record_usage($usage_records, $client_receipt_id = null)
    {
     ...
     * @param int $auto_skip_to_next_bill_date Preview either prior period not billed statement or current period statement when called during bill lag days
     ...
     */
    public function get_acct_preview_statement($acct_no, $alt_stmt_template_no = null, $auto_skip_to_next_bill_date = null)
    {
        return $this->__ws_call('get_acct_preview_statement', Array(
                'acct_no' => $acct_no,
                'alt_stmt_template_no' => $alt_stmt_template_no,
                'auto_skip_to_next_bill_date' => $auto_skip_to_next_bill_date
        ));
    }
