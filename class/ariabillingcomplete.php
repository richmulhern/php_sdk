...
class AriaBillingComplete extends BaseAriaBilling
{
     ...
     * @param long $limit The maximum number of objects that should be returned by this call.
     * @param long $offset The number of records to skip. Note that both &quot;0&quot; and NULL will cause the interface not to skip any records.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long starting_record This indicates the number of objects that were (or would be) skipped before beginning output.<br> total_records This is the total number of objects that matched the provided criteria.<br>hash account_details 
     */
     ...
     * @param long $limit The maximum number of objects that should be returned by this call.
     * @param long $offset The number of records to skip. Note that both &quot;0&quot; and NULL will cause the interface not to skip any records.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long starting_record This indicates the number of objects that were (or would be) skipped before beginning output.<br> total_records This is the total number of objects that matched the provided criteria.<br>hash account_status_history 
     */
     ...
     * @param long $limit The maximum number of objects that should be returned by this call.
     * @param long $offset The number of records to skip. Note that both &quot;0&quot; and NULL will cause the interface not to skip any records.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long starting_record This indicates the number of objects that were (or would be) skipped before beginning output.<br> total_records This is the total number of objects that matched the provided criteria.<br>hash account_plan_history 
     */
     ...
     * @param long $limit The maximum number of objects that should be returned by this call.
     * @param long $offset The number of records to skip. Note that both &quot;0&quot; and NULL will cause the interface not to skip any records.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long starting_record This indicates the number of objects that were (or would be) skipped before beginning output.<br> total_records This is the total number of objects that matched the provided criteria.<br>hash payment_details 
     */
     ...
     * @param long $limit The maximum number of objects that should be returned by this call.
     * @param long $offset The number of records to skip. Note that both &quot;0&quot; and NULL will cause the interface not to skip any records.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long starting_record This indicates the number of objects that were (or would be) skipped before beginning output.<br> total_records This is the total number of objects that matched the provided criteria.<br>hash order_details 
     */
     ...
     * @param long $plan_no Aria assigned unique plan identifier
     ...
     * @param long $parent_plan_no Aria assigned unique plan identifier for the parent plan
     * @param hash $supp_field_names 
     * @param hash $supp_field_values 
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash all_client_plans A multidimensional array containing all client plans.
     */
     ...
     * @return mixed[] long status_cd This is the status of the object inquestion for the current API call.<br>string load_date_time Date and time the file load was attempted.<br>long recs_received Total number of records received<br>long recs_loaded Total number of records successfully loaded<br>long recs_failed Total number of records that failed to load.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] string country_code This is a phone number dialing predicate indicating the country to dial.<br>string country_name Country name returned from a search using the provided IP address.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $filter_currency_cd The 3-digit ISO currency code for monetary values used in the context of this API method.
     ...
     * @param long $filter_item_no Aria-assigned unique identifier indicating Client Inventory Item.
     * @return mixed[] hash client_items <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $return_no_cost_items A boolean value that asserts the API call should include no-cost items in its returned results (true/1=yes, false/0=no).
     * @param long $filter_item_no Aria-assigned unique identifier indicating Client Inventory Item.
     * @return mixed[] hash all_client_items <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $filter_currency_cd The 3-digit ISO currency code for monetary values used in the context of this API method.
     * @param string $return_no_cost_items A boolean value that asserts the API call should include no-cost items in its returned results (true/1=yes, false/0=no).
     * @return mixed[] hash all_item_prices <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $filter_item_no Aria-assigned unique identifier indicating Client Inventory Item.
     * @return mixed[] hash all_item_supp_fields <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $filter_item_no Aria-assigned unique identifier indicating Client Inventory Item.
     * @return mixed[] hash all_item_classes <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    ...
    /**
     * get an array of values for an array of input web replacement strings
     * @param hash $web_vals_in 
     * @return mixed[] hash web_vals_out <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $plan_no The unique plan identifier, if only one plan is desired.
     * @return mixed[] hash plans_basic <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $plan_no The unique plan identifier.
     * @return mixed[] hash plan_services <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    ...
    /**
     * Returns information about the rates for a particular service in a specified plan.
     * @param long $service_no Aria assigned unique service identifier
     * @param long $plan_no The unique plan identifier.
     * @param long $alt_rate_schedule_no Alternative Rate Schedule Number. The alt_rate_schedule_no is the unique identifier for an alternative rate schedule that can be assigned to the account holder in place of the default rate schedule. This is often done by CSR&#039;s to provide special compensation or discounts as incentives to account holders.
     * @return mixed[] hash plan_service_rates Represents the rates for the default rate schedule for the default currency for the plan<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function get_client_plan_service_rates($service_no, $plan_no = null, $alt_rate_schedule_no = null)
    {
     ...
     * @return mixed[] hash client_country <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $class_no The class to assign to the client
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash events An array of events returned from the successful completion of this API call
     */
     ...
     * @param long $class_no The event class number to unsubscribe from.
     * @param string $do_write Boolean indicator informing Aria whether or not to actually perform the requested plan assignment/de-assignment. If &#039;false&#039; is passed in this field Aria will, if applicable, calculate any potential proration effect that would result from this call and return that value in the output field &#039;proration_result_amount&#039; described below without actually performing the requested operation or charging/crediting the account. This is useful to interfaces that wish to present the user with a &#039;confirmation page&#039; informing of the would-be effects of the requested operation prior to actually performing it.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash events An Array of events being unsubscribed to.
     */
     ...
     * @param long $event_id The unique identifier for a given provisioning event.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $class_no The event class to query of the superclass
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string response Array of events the client has subscribed to.
     */
     ...
     * @param long $rand_length Identifies how many characters should be in the random string.
     * @param string $rand_case Identifies the case of the letters returned in the random string. &quot;U&quot; = upper. &quot;L&quot; = lower. &quot;M&quot; = mixed (default).
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string random_string Random string generated by the API method.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash rate_sched An array of the rate schedules for the requested plan
     */
    public function get_rate_schedules_for_plan($plan_no = null, $currency_cd = null)
    {
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash client_receipt 
     */
     ...
     * @param string $return_no_cost_items A boolean value that asserts the API call should include no-cost items in its returned results (true/1=yes, false/0=no).
     * @param long $filter_item_no Aria-assigned unique identifier indicating Client Inventory Item.
     * @return mixed[] hash items_basic <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] hash out_reg_uss_params <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $session_id Client-assigned identifier for the application session.
     * @param hash $in_reg_uss_params 
     * @param long $override_timeout_minutes Number of minutes from current time until session expires
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] hash out_reg_uss_config_params <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * Creates a configuration set that can be used to customize the global functionality of a registration or User Self Service application.
     * @param string $set_name Client-defined identifier for this set of global application configuration parameters.
     * @param hash $in_reg_uss_config_params 
     * @param string $set_description The description to be used for a newly-created set
     * @param long $set_type_no If creating a new set, the set type number, for determining if this is reg, USS, etc.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param hash $inventory_item_stock 
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash new_inventory_item_stock 
     */
     ...
     * @return mixed[] hash client_currency <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $item_no The item number by which to search for images
     * @return mixed[] hash item_images <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] hash top_item_class <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $filter_class_no An item class number to use to filter results.
     * @return mixed[] hash parent_item_class <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $filter_class_no An item class number to use to filter results.
     * @return mixed[] hash child_item_class <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $filter_class_no An item class number to use to filter results.
     * @return mixed[] hash class_items <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $field_no The plan supplemental field number which is being searched against
     * @param string $field_name The optional name of this supplemental field, if the number is not known
     * @return mixed[] hash master_plans_by_supp_field <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $field_no The plan supplemental field number which is being searched against
     * @param string $field_name The optional name of this supplemental field, if the number is not known
     * @return mixed[] hash supp_plans_by_supp_field <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $field_no The plan supplemental field number which is being searched against
     * @param string $field_name The optional name of this supplemental field, if the number is not known
     * @return mixed[] hash items_by_supp_field <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] hash templates_by_client <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string virtual_date The current virtual system date for the given client, in format YYYY-MM-DD (after application of input parameter &quot;offset_hours&quot;).<br>string virtual_time The current virtual system time for the given client, in format HH24:MI:SS (after application of input parameter &quot;offset_hours&quot;).<br>string system_date The current actual system date,in format YYYY-MM-DD.<br>string system_time The current actual system time,in format HH24:MI:SS.<br>long current_offset_hours The difference, in truncated hours, between the client&#039;s current virtual date/time and the actual system date/time. Will always be zero or a positive integer in non-production systems, and will always be a zero in production systems after application of input parameter &quot;offset_hours&quot;).<br>string is_batch_running Returns &quot;Y&quot; or &quot;N&quot; depending on if the batch jobs are running in the background.
     */
     ...
     * @param long $offset_hours The positive integer number of hours by which to advance the given client&#039;s current virtual time.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string virtual_date The current virtual system date for the given client, in format YYYY-MM-DD (after application of input parameter &quot;offset_hours&quot;).<br>string virtual_time The current virtual system time for the given client, in format HH24:MI:SS (after application of input parameter &quot;offset_hours&quot;).<br>string system_date The current actual system date,in format YYYY-MM-DD.<br>string system_time The current actual system time,in format HH24:MI:SS.<br>long current_offset_hours The difference, in truncated hours, between the client&#039;s current virtual date/time and the actual system date/time. Will always be zero or a positive integer in non-production systems, and will always be a zero in production systems after application of input parameter &quot;offset_hours&quot;).
     */
     ...
     * @param long $destination_id The external system identifier
     * @param long $source_type_id The type of Aria object being referenced
     * @param long $object_id The ID of the Aria object being referenced
     * @param string $external_id The external system ID being assigned
     * @param long $action_directive Either &quot;add&quot; or &quot;merge&quot;
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts. If passed, only the coupons assigned to this account will be returned.
     * @param string $coupon_cd If passed, only the details for the coupon specified will be returned.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash coupons 
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $status_cd This is the status of the object inquestion for the current API call.
     * @param long $queue_days Days in to queue before the status change occurs.
     * @param string $queue_date Specific date for the status change to occur
     * @param long $force_bill_date_reset Reset the billing anniversary date to coincide with the status change.
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $notify_method If notification method is not provided, value will default to 1 (HTML email).
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts..
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long notify_method If notification method is not provided, value will default to 1 (HTML emal).<br>string notify_method_name The name of the notify method to be used in communicating with the account holder.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $pay_method This is the method_id corresponding to a payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param long $senior_account_no The account number of the account assuming payment responsibility for billing.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $CVV The CVV code for the payment method given
     * @param long $seq_no The unique bill sequence number.
     ...
     * @param long $alt_pay_method If you wish to use the account&#039;s current form of payment, leave this value empty. If you wish to use an alternate credit card, enter &#039;1&#039; for this value.
     * @param string $cc_number Credit card number.
     * @param long $cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param string $currency_cd The 3-digit ISO currency code for monetary values used in the context of this API method.
     * @param long $acct_group_no The collections account group for this account
     ...
     * @param long $days_to_restore Number of days the ban is to be in place before being restored.
     ...
     * @param long $reason_cd The reason why this account was banned
     * @param string $comments Additional explanitory text relating to this API call.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts..
     * @param long $transaction_type Transaciton type to search account history for.
     ...
     * @param long $record_limit This is the maximum number of records to retrieve from the query.
     * @param long $filter_statement_no Statement number filter to use when querying for account transaction history.
     * @param string $include_void_transactions Allows whether or not to include void transactions.
     * @return mixed[] hash history <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $cc_expire_mm Credit card expiration month, 2-digit
     * @param long $cc_expire_yyyy Credit card expiration year, 4-digit
     ...
     * @param long $payment_source Records the source of this payment information
     ...
     * @param long $bill_seq The unique identifier of the bill sequence number.
     * @param string $inTrackingNumber The XID used for 3DSecure if 3DSecure was used for this authorization
     * @param string $inAuthValue The 3DSecure authorization value
     * @param string $alt_client_acct_group_id The one-time collections account group  to use for this particular call.  The default on the account is not changed.
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     ...
     * @param long $account_number Aria-assigned account identifier. This value is unique across all Aria-managed accounts..
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash queued_plans An array of plans queued for the specified account number<br>long current_rate_schedule_no The current rate schedule number for the plan used by the specified account number
     */
     ...
     * @param long $account_number Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash stat_hist An array of status history records for the account.
     */
     ...
     * @param long $account_number Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash plan_hist This is an array of plan history records.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $plan_no The unique plan identifier.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash supp_plan_hist 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash plans An array of plans.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash all_plans This return value is a multidimensional array describing the detail of all available plans.
     */
     ...
     * @param string $promo_code This is the code provided the client  and used by the account holder during registration or when executing a transaction.A promotion generally provides  access to a custom set of reduced-rate plans.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash plans This return value is a multidimensional array describing the detail of all available plans on this promo code.
     */
     ...
     * @param long $parent_acct_no The parent account for this child account. Designating a parent account number implies the account holder is under a parent account umbrella.
     * @param string $do_multi_level Allow mult-level account hierarchies.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash child_accts 
     */
     ...
     * @param long $parent_acct_no The parent account for this child account. Designating a parent account number implies the account holder is under a parent account umbrella.
     * @param string $do_multi_level Allow mult-level account hierarchies.
     * @param long $trans_type Valid transaction type to use when searching family transaction history.
     * @param string $start_date Specifies start date. The date is in the format yyyy-mm-dd
     * @param string $end_date Specifies end date. The date is in the format yyyy-mm-dd
     * @param long $record_limit This is the maximum number of records to retrieve from the query.
     * @param string $include_void_transactions Allows whether or not to include void transactions.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash fam_trans 
     */
     ...
     * @param long $cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $cc_expire_yyyy Expiration year for the credit card payment instrument.
     * @param long $phone_npa Phone Numbering Plan Area value (also known as area code).
     * @param long $phone_nxx Phone Exchange (first 3 numbers following the area code/NPA).
     ...
     * @param string $email Email of the contact
     * @param string $locality Locality of the contact
     * @param long $cell_phone_npa Cell phone Numbering Plan Area value (also known as area code).
     * @param long $cell_phone_nxx Cell phone Exchange (first 3 numbers following the area code/NPA).
     * @param string $cell_phone_suffix Cell phone number (this is the number on the exchange/NXX for the target phone).
     * @param long $work_phone_npa Phone Numbering Plan Area value (also known as area code).
     * @param long $work_phone_nxx Phone Exchange (first 3 numbers following the area code/NPA).
     ...
     * @param long $template_no The specific Email Template to send
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash su 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $usage_type The type of usage being consumed by the account holder
     ...
     * @param long $standing_usage_rec_no The record number of the standing usage order, as returned by the get_standing_usage API
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $comments Additional explanitory text relating to this API call.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_plans 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash all_acct_plans 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash supp_fields 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $field_name The supplemental field name.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash supp_field_values 
     */
     ...
     * @param string $promo_code This is the code provided the client  and used by the account holder during registration or when executing a transaction.A promotion generally provides access to a custom set of reduced-rate plans.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash plans 
     */
     ...
     * @param long $offset_months For plan recurring intervals of longer than one month, the number of months to offset proration and first bill date
     * @param long $auto_offset_months_option Automatically set the offset for the billing anniversary month.
     * @param string $alt_proration_start_date This argument specifies and alternate proration start date.
     * @param string $alt_client_acct_group_id The one-time collections account group  to use for this particular call.  The default on the account is not changed.
     * @param hash $new_acct_custom_rates 
     ...
     * @param long $supp_plan_no The Aria-assigned identifier for a supplemental service plan. Allowable values are limited to valid custom plan numbers for client.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $alt_rate_schedule_no Alternate rate schedule number to assign (if any). If none is specified then the default rate schedule number will be used.
     * @param long $num_plan_units The factor by which all future recurring fees for this plan will be multiplied on future invoices for this account. EXAMPLE: An account wishes to have the supplemental plan titled Seats of XYZ Application assigned to them, with a monthly flat cost of $10.00 per seat. To assign 5 seats of this plan to the account, resulting in a monthly charge of $50.00 to the account, a value of 5 should be passed in this field.
     * @param string $coupon_code The code of the coupon to which to apply the discount.  If code is not valid for any reason, an appropriate error code is returned and the entire transaction (including the supp plan assignment and any possible invoice creation) is rolled back.
     * @param long $assignment_directive The scope rule to be applied to this assignment/de-assignment request, governing both the date upon which the assignment should take place (immediately or on the account&#039;s anniversary date) and the proration rule that should be applied (per client&#039;s default rules for proration on plan assignment v. forcing proration on or off for this request only). Default behavior is to assign plan to account on the account&#039;s anniversary date, resulting in no proration effect.
     * @param string $comments Additional explanitory text relating to this API call.
     ...
     * @param long $existing_supp_plan_no The Supplemental Plan number to be replaced from this action.
     * @param long $new_supp_plan_no The new Supplemental Plan number to use as the replacement supplemental plan.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $alt_rate_schedule_no Alternative Rate Schedule Number. The alt_rate_schedule_no is the unique identifier for an alternative rate schedule that can be assigned to the account holder in place of the default rate schedule. This is often done by CSR&#039;s to provide special compensation or discounts as incentives to account holders.
     * @param long $num_plan_units The factor by which all future recurring fees for this plan will be multiplied on future invoices for this account. EXAMPLE: An account wishes to have the supplemental plan titled Seats of XYZ Application assigned to them, with a monthly flat cost of $10.00 per seat. To assign 5 seats of this plan to the account, resulting in a monthly charge of $50.00 to the account, a value of 5 should be passed in this field.
     * @param string $coupon_code The code of the coupon to which to apply the discount.  If code is not valid for any reason, an appropriate error code is returned and the entire transaction (including the supp plan assignment and any possible invoice creation) is rolled back.
     ...
     * @param string $do_write Boolean indicator informing Aria whether or not to actually perform the requested plan assignment/de-assignment. If &#039;false&#039; is passed in this field Aria will, if applicable, calculate any potential proration effect that would result from this call and return that value in the output field &#039;proration_result_amount&#039; described below without actually performing the requested operation or charging/crediting the account. This is useful to interfaces that wish to present the user with a &#039;confirmation page&#039; informing of the would-be effects of the requested operation prior to actually performing it.
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @param long $offset_months Number of months to add to the prorated period.
     * @param long $auto_offset_months_option Automatically set offset months
     * @param string $alt_client_acct_group_id The one-time collections account group  to use for this particular call.  The default on the account is not changed.
     * @param hash $new_acct_custom_rates 
     * @param string $effective_date If the assignment directive is for future date assignment, this is the effective date for that assignment
     * @param long $offset_interval If assigning a change on an anniversary day, the number of billing periods by which to delay that change
    ...
    /**
     * return array of all available child plans subordinate to the given input plan number
     * @param long $in_plan_no Plan for which to query available child plans
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash plans 
     */
     ...
     * @param long $in_plan_no The Plan number to acquire a list of all child plans for.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash all_plans This return value is a multidimensional array describing the detail of all available plans.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_groups 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $group_no The group number to use when retreiveing plans assigned to a group.
     ...
     * @param long $master_plan_no The Master Subscription plan number.
     ...
     * @param string $userid The users unique identifier.
     * @param long $status_cd This is the status of the object inquestion for the current API call.
     * @param long $master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param hash $supp_plans 
     * @param hash $supp_plan_units 
     * @param long $notify_method If notification method is not provided, value will default to 1 (HTML emal).
     ...
     * @param long $resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param long $senior_acct_no The senior_acct_no is the unique account number for the parent account and is used in establishing parent-child billing relationships.
     * @param hash $functional_acct_groups 
     * @param hash $collections_acct_groups 
     * @param hash $supp_field_names 
     * @param hash $supp_field_values 
     * @param long $test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @param long $status_until_alt_start The status for the account prior to alt_start_date. This is only used if the alternate start date is used.
     ...
     * @param long $alt_bill_day The day of the month that will act in perpetuity as the account&#039;s billing anniversary day.
     ...
     * @param long $master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param hash $supp_plan_alt_rate_sched_no 
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     ...
     * @param hash $coupon_codes 
     * @param hash $new_acct_custom_rates 
     * @param long $alt_msg_template_no Email template number assigned to this account.
     * @param long $seq_func_group_no Functional account group number specifically designated for statement sequence number assignment.
     * @param hash $new_acct_plan_contracts 
     * @param string $address3 The third line of the address
     * @param string $bill_address3 The third line of the billing address
     * @param hash $usage_accumulation_config The array of plans for which to enable usage accumulation
     * @param hash $enable_usage_pooling_plan_no 
     * @param hash $client_func_acct_group_ids 
     * @param hash $client_coll_acct_group_ids 
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param string $track_data2 The raw &quot;track 2&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     ...
     * @param long $tax_exemption_level To provide Tax Exemption Level for the account
     * @param long $cn_alt_msg_template_no The alternate email template number to use for this account
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.<br>string out_userid The user ID, unique among all accounts for this Aria client, assigned to the newly created account.  If input parameter &quot;user_id&quot; was provided, the same value will be returned.  If no &quot;user_id&quot; was provided as input and the client is configured within Aria for automatic generation of random user_id values OR is configured to use account email addresses as user_ids, the generated value will be returned.<br>long invoicing_error_code Aria-defined error code specific to any error encountered during any invoicing/billing processes performed inline as a result of this method call.<br>string invoicing_error_msg The explanatory text corresponding to the value returned (if any) in output &quot;invoicing_error_code&quot;.<br>long invoice_no The unique identifer of the invoice, if any, created automatically by Aria in conjunction with this call.<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>hash out_new_acct_plan_contracts <br>double invoice_charges_before_tax Charges before tax on the initial invoice for this account<br>double invoice_tax_charges Tax charges on the initial invoice for this account<br>double invoice_charges_after_tax The sum of invoice_charges_before_tax and invoice_tax_charges<br>double invoice_credit_amount The amount of credit on the initial invoice for this account<br>double invoice_total_amount The total owed on the initial invoice for this account<br>hash new_acct_invoice_line_items <br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param long $a1_master_plan_no The Master Subscription plan number.
     * @param string $do_write Boolean indicator informing Aria whether or not to actually perform the requested operation. If &#039;false&#039; is passed in this field Aria will, if applicable, calculate any potential effects stemming from this call such as pro-ration, plan assignments, etc. and return all relevant data  without actually performing the requested operation or making any changes to the account. This is useful to interfaces that wish to present the user with a &#039;confirmation page&#039; informing of the would-be effects of the requested operation prior to actually performing it.  Do_write defaults to &#039;true&#039;
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     ...
     * @param long $a1_status_cd This is the status of the object inquestion for the current API call.
     * @param long $a1_master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param hash $a1_supp_plans 
     * @param hash $a1_supp_plan_units 
     * @param long $a1_notify_method If notification method is not provided, value will default to 1 (HTML emal).
     ...
     * @param long $a1_pay_method This is the method_id corresponding to a payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a1_cc_number Credit card number.
     * @param long $a1_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $a1_cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param long $a1_resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param hash $a1_functional_acct_groups 
     * @param hash $a1_collections_acct_groups 
     * @param hash $a1_supp_field_names 
     * @param hash $a1_supp_field_values 
     * @param long $a1_test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @param long $a1_status_until_alt_start The status for the account prior to alt_start_date. This is only used if the alternate start date is used.
     ...
     * @param long $a1_alt_bill_day The day of the month that will act in perpetuity as the account&#039;s billing anniversary day.
     ...
     * @param long $a1_master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param hash $a1_supp_plan_alt_rate_sched_no 
     ...
     * @param hash $a1_coupon_codes 
     * @param hash $a1_new_acct_custom_rates 
     * @param long $a1_alt_msg_template_no Email template number assigned to this account.
     * @param long $a1_seq_func_group_no Functional account group number specifically designated for statement sequence number assignment.
     * @param hash $a1_new_acct_plan_contracts 
     ...
     * @param hash $a1_usage_accumulation_config The array of plans for which to enable usage accumulation
     * @param hash $a1_enable_usage_pooling_plan_no 
     * @param hash $a1_client_func_acct_group_ids 
     * @param hash $a1_client_coll_acct_group_ids 
     ...
     * @param long $a1_tax_exemption_level To provide Tax Exemption Level for the account
     * @param long $a1_cn_alt_msg_template_no The alternate email template number to use for this account
     ...
     * @param long $a2_status_cd This is the status of the object inquestion for the current API call.
     * @param long $a2_master_plan_no The Master Subscription plan number.
     * @param long $a2_master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param hash $a2_supp_plans 
     * @param hash $a2_supp_plan_units 
     * @param long $a2_notify_method If notification method is not provided, value will default to 1 (HTML emal).
     ...
     * @param long $a2_pay_method This is the method_id corresponding to a payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a2_cc_number Credit card number.
     * @param long $a2_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $a2_cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param long $a2_resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param hash $a2_functional_acct_groups 
     * @param hash $a2_collections_acct_groups 
     * @param hash $a2_supp_field_names 
     * @param hash $a2_supp_field_values 
     * @param long $a2_test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @param long $a2_status_until_alt_start The status for the account prior to alt_start_date. This is only used if the alternate start date is used.
     ...
     * @param long $a2_alt_bill_day The day of the month that will act in perpetuity as the account&#039;s billing anniversary day.
     ...
     * @param long $a2_master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param hash $a2_supp_plan_alt_rate_sched_no 
     ...
     * @param hash $a2_coupon_codes 
     * @param hash $a2_new_acct_custom_rates 
     * @param long $a2_alt_msg_template_no Email template number assigned to this account.
     * @param long $a2_seq_func_group_no Functional account group number specifically designated for statement sequence number assignment.
     * @param hash $a2_new_acct_plan_contracts 
     ...
     * @param hash $a2_usage_accumulation_config The array of plans for which to enable usage accumulation
     * @param hash $a2_enable_usage_pooling_plan_no 
     * @param hash $a2_client_func_acct_group_ids 
     * @param hash $a2_client_coll_acct_group_ids 
     ...
     * @param long $a2_tax_exemption_level To provide Tax Exemption Level for the account
     * @param long $a2_cn_alt_msg_template_no The alternate email template number to use for this account
     ...
     * @param long $a3_status_cd This is the status of the object inquestion for the current API call.
     * @param long $a3_master_plan_no The Master Subscription plan number.
     * @param long $a3_master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param hash $a3_supp_plans 
     * @param hash $a3_supp_plan_units 
     * @param long $a3_notify_method If notification method is not provided, value will default to 1 (HTML emal).
     ...
     * @param long $a3_pay_method This is the method_id corresponding to a payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a3_cc_number Credit card number.
     * @param long $a3_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $a3_cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param long $a3_resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param hash $a3_functional_acct_groups 
     * @param hash $a3_collections_acct_groups 
     * @param hash $a3_supp_field_names 
     * @param hash $a3_supp_field_values 
     * @param long $a3_test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @param long $a3_status_until_alt_start The status for the account prior to alt_start_date. This is only used if the alternate start date is used.
     ...
     * @param long $a3_alt_bill_day The day of the month that will act in perpetuity as the account&#039;s billing anniversary day.
     ...
     * @param long $a3_master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param hash $a3_supp_plan_alt_rate_sched_no 
     ...
     * @param hash $a3_coupon_codes 
     * @param hash $a3_new_acct_custom_rates 
     * @param long $a3_alt_msg_template_no Email template number assigned to this account.
     * @param long $a3_seq_func_group_no Functional account group number specifically designated for statement sequence number assignment.
     * @param hash $a3_new_acct_plan_contracts 
     ...
     * @param hash $a3_usage_accumulation_config The array of plans for which to enable usage accumulation
     * @param hash $a3_enable_usage_pooling_plan_no 
     * @param hash $a3_client_func_acct_group_ids 
     * @param hash $a3_client_coll_acct_group_ids 
     ...
     * @param long $a3_tax_exemption_level To provide Tax Exemption Level for the account
     * @param long $a3_cn_alt_msg_template_no The alternate email template number to use for this account
     ...
     * @param long $a4_status_cd This is the status of the object inquestion for the current API call.
     * @param long $a4_master_plan_no The Master Subscription plan number.
     * @param long $a4_master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param hash $a4_supp_plans 
     * @param hash $a4_supp_plan_units 
     * @param long $a4_notify_method If notification method is not provided, value will default to 1 (HTML emal).
     ...
     * @param long $a4_pay_method This is the method_id corresponding to a payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a4_cc_number Credit card number.
     * @param long $a4_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $a4_cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param long $a4_resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param hash $a4_functional_acct_groups 
     * @param hash $a4_collections_acct_groups 
     * @param hash $a4_supp_field_names 
     * @param hash $a4_supp_field_values 
     * @param long $a4_test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @param long $a4_status_until_alt_start The status for the account prior to alt_start_date. This is only used if the alternate start date is used.
     ...
     * @param long $a4_alt_bill_day The day of the month that will act in perpetuity as the account&#039;s billing anniversary day.
     ...
     * @param long $a4_master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param hash $a4_supp_plan_alt_rate_sched_no 
     ...
     * @param hash $a4_coupon_codes 
     * @param hash $a4_new_acct_custom_rates 
     * @param long $a4_alt_msg_template_no Email template number assigned to this account.
     * @param long $a4_seq_func_group_no Functional account group number specifically designated for statement sequence number assignment.
     * @param hash $a4_new_acct_plan_contracts 
     ...
     * @param hash $a4_usage_accumulation_config The array of plans for which to enable usage accumulation
     * @param hash $a4_enable_usage_pooling_plan_no 
     * @param hash $a4_client_func_acct_group_ids 
     * @param hash $a4_client_coll_acct_group_ids 
     ...
     * @param long $a4_tax_exemption_level To provide Tax Exemption Level for the account
     * @param long $a4_cn_alt_msg_template_no The alternate email template number to use for this account
     ...
     * @param long $a5_status_cd This is the status of the object inquestion for the current API call.
     * @param long $a5_master_plan_no The Master Subscription plan number.
     * @param long $a5_master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param hash $a5_supp_plans 
     * @param hash $a5_supp_plan_units 
     * @param long $a5_notify_method If notification method is not provided, value will default to 1 (HTML emal).
     ...
     * @param long $a5_pay_method This is the method_id corresponding to a payment method such as credit card, Electronic Check, Pre-Paid, Net Terms, etc.
     * @param string $a5_cc_number Credit card number.
     * @param long $a5_cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $a5_cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param long $a5_resp_level_cd The responsibility level code. These are values 1 through 4 as described in the legend for this argument.
     * @param hash $a5_functional_acct_groups 
     * @param hash $a5_collections_acct_groups 
     * @param hash $a5_supp_field_names 
     * @param hash $a5_supp_field_values 
     * @param long $a5_test_acct_ind This argument indicates the account is a test account and is treated as such in the system.
     * @param long $a5_status_until_alt_start The status for the account prior to alt_start_date. This is only used if the alternate start date is used.
     ...
     * @param long $a5_alt_bill_day The day of the month that will act in perpetuity as the account&#039;s billing anniversary day.
     ...
     * @param long $a5_master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param hash $a5_supp_plan_alt_rate_sched_no 
     ...
     * @param hash $a5_coupon_codes 
     * @param hash $a5_new_acct_custom_rates 
     * @param long $a5_alt_msg_template_no Email template number assigned to this account.
     * @param long $a5_seq_func_group_no Functional account group number specifically designated for statement sequence number assignment.
     * @param hash $a5_new_acct_plan_contracts 
     ...
     * @param hash $a5_usage_accumulation_config The array of plans for which to enable usage accumulation
     * @param hash $a5_enable_usage_pooling_plan_no 
     * @param hash $a5_client_func_acct_group_ids 
     * @param hash $a5_client_coll_acct_group_ids 
     ...
     * @param long $a5_tax_exemption_level To provide Tax Exemption Level for the account
     * @param long $a5_cn_alt_msg_template_no The alternate email template number to use for this account
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long a1_error_code Aria-assigned error identifier. 0 indicates no error.<br>string a1_error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long a1_acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.<br>string a1_out_userid The user ID, unique among all accounts for this Aria client, assigned to the newly created account.  If input parameter &quot;user_id&quot; was provided, the same value will be returned.  If no &quot;user_id&quot; was provided as input and the client is configured within Aria for automatic generation of random user_id values OR is configured to use account email addresses as user_ids, the generated value will be returned.<br>string a1_out_client_acct_id The client_acct_id of this account, if one was supplied by the client.<br>long a1_invoicing_error_code Aria-defined error code specific to any error encountered during any invoicing/billing processes performed inline as a result of this method call.<br>string a1_invoicing_error_msg The explanatory text corresponding to the value returned (if any) in output &quot;invoicing_error_code&quot;.<br>long a1_invoice_no The unique identifer of the invoice, if any, created automatically by Aria in conjunction with this call.<br>string a1_proc_cvv_response The processor return code from CVV validation (deprecated)<br>string a1_proc_avs_response Processor return code from address validation<br>string a1_proc_cavv_response The processors return code for security validation (includes cvv)<br>string a1_proc_status_code The processor status code<br>string a1_proc_status_text The processors status description<br>string a1_proc_payment_id The processor payment id<br>string a1_proc_auth_code Authorization code provided by the issuing bank<br>string a1_proc_merch_comments Additional information passed to payment processor<br>hash a1_out_new_acct_plan_contracts <br>double a1_invoice_charges_before_tax Charges before tax on the initial invoice for this account<br>double a1_invoice_tax_charges Tax charges on the initial invoice for this account<br>double a1_invoice_charges_after_tax The sum of invoice_charges_before_tax and invoice_tax_charges<br>double a1_invoice_credit_amount The amount of credit on the initial invoice for this account<br>double a1_invoice_total_amount The total owed on the initial invoice for this account<br>hash a1_new_acct_invoice_line_items <br>hash a1_third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.<br>long a2_error_code Aria-assigned error identifier. 0 indicates no error.<br>string a2_error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long a2_acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.<br>string a2_out_userid The user ID, unique among all accounts for this Aria client, assigned to the newly created account.  If input parameter &quot;user_id&quot; was provided, the same value will be returned.  If no &quot;user_id&quot; was provided as input and the client is configured within Aria for automatic generation of random user_id values OR is configured to use account email addresses as user_ids, the generated value will be returned.<br>string a2_out_client_acct_id The client_acct_id of this account, if one was supplied by the client.<br>long a2_invoicing_error_code Aria-defined error code specific to any error encountered during any invoicing/billing processes performed inline as a result of this method call.<br>string a2_invoicing_error_msg The explanatory text corresponding to the value returned (if any) in output &quot;invoicing_error_code&quot;.<br>long a2_invoice_no The unique identifer of the invoice, if any, created automatically by Aria in conjunction with this call.<br>string a2_proc_cvv_response The processor return code from CVV validation (deprecated)<br>string a2_proc_avs_response Processor return code from address validation<br>string a2_proc_cavv_response The processors return code for security validation (includes cvv)<br>string a2_proc_status_code The processor status code<br>string a2_proc_status_text The processors status description<br>string a2_proc_payment_id The processor payment id<br>string a2_proc_auth_code Authorization code provided by the issuing bank<br>string a2_proc_merch_comments Additional information passed to payment processor<br>hash a2_out_new_acct_plan_contracts <br>double a2_invoice_charges_before_tax Charges before tax on the initial invoice for this account<br>double a2_invoice_tax_charges Tax charges on the initial invoice for this account<br>double a2_invoice_charges_after_tax The sum of invoice_charges_before_tax and invoice_tax_charges<br>double a2_invoice_credit_amount The amount of credit on the initial invoice for this account<br>double a2_invoice_total_amount The total owed on the initial invoice for this account<br>hash a2_new_acct_invoice_line_items <br>hash a2_third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.<br>long a3_error_code Aria-assigned error identifier. 0 indicates no error.<br>string a3_error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long a3_acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.<br>string a3_out_userid The user ID, unique among all accounts for this Aria client, assigned to the newly created account.  If input parameter &quot;user_id&quot; was provided, the same value will be returned.  If no &quot;user_id&quot; was provided as input and the client is configured within Aria for automatic generation of random user_id values OR is configured to use account email addresses as user_ids, the generated value will be returned.<br>string a3_out_client_acct_id The client_acct_id of this account, if one was supplied by the client.<br>long a3_invoicing_error_code Aria-defined error code specific to any error encountered during any invoicing/billing processes performed inline as a result of this method call.<br>string a3_invoicing_error_msg The explanatory text corresponding to the value returned (if any) in output &quot;invoicing_error_code&quot;.<br>long a3_invoice_no The unique identifer of the invoice, if any, created automatically by Aria in conjunction with this call.<br>string a3_proc_cvv_response The processor return code from CVV validation (deprecated)<br>string a3_proc_avs_response Processor return code from address validation<br>string a3_proc_cavv_response The processors return code for security validation (includes cvv)<br>string a3_proc_status_code The processor status code<br>string a3_proc_status_text The processors status description<br>string a3_proc_payment_id The processor payment id<br>string a3_proc_auth_code Authorization code provided by the issuing bank<br>string a3_proc_merch_comments Additional information passed to payment processor<br>hash a3_out_new_acct_plan_contracts <br>double a3_invoice_charges_before_tax Charges before tax on the initial invoice for this account<br>double a3_invoice_tax_charges Tax charges on the initial invoice for this account<br>double a3_invoice_charges_after_tax The sum of invoice_charges_before_tax and invoice_tax_charges<br>double a3_invoice_credit_amount The amount of credit on the initial invoice for this account<br>double a3_invoice_total_amount The total owed on the initial invoice for this account<br>hash a3_new_acct_invoice_line_items <br>hash a3_third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.<br>long a4_error_code Aria-assigned error identifier. 0 indicates no error.<br>string a4_error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long a4_acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.<br>string a4_out_userid The user ID, unique among all accounts for this Aria client, assigned to the newly created account.  If input parameter &quot;user_id&quot; was provided, the same value will be returned.  If no &quot;user_id&quot; was provided as input and the client is configured within Aria for automatic generation of random user_id values OR is configured to use account email addresses as user_ids, the generated value will be returned.<br>string a4_out_client_acct_id The client_acct_id of this account, if one was supplied by the client.<br>long a4_invoicing_error_code Aria-defined error code specific to any error encountered during any invoicing/billing processes performed inline as a result of this method call.<br>string a4_invoicing_error_msg The explanatory text corresponding to the value returned (if any) in output &quot;invoicing_error_code&quot;.<br>long a4_invoice_no The unique identifer of the invoice, if any, created automatically by Aria in conjunction with this call.<br>string a4_proc_cvv_response The processor return code from CVV validation (deprecated)<br>string a4_proc_avs_response Processor return code from address validation<br>string a4_proc_cavv_response The processors return code for security validation (includes cvv)<br>string a4_proc_status_code The processor status code<br>string a4_proc_status_text The processors status description<br>string a4_proc_payment_id The processor payment id<br>string a4_proc_auth_code Authorization code provided by the issuing bank<br>string a4_proc_merch_comments Additional information passed to payment processor<br>hash a4_out_new_acct_plan_contracts <br>double a4_invoice_charges_before_tax Charges before tax on the initial invoice for this account<br>double a4_invoice_tax_charges Tax charges on the initial invoice for this account<br>double a4_invoice_charges_after_tax The sum of invoice_charges_before_tax and invoice_tax_charges<br>double a4_invoice_credit_amount The amount of credit on the initial invoice for this account<br>double a4_invoice_total_amount The total owed on the initial invoice for this account<br>hash a4_new_acct_invoice_line_items <br>hash a4_third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.<br>long a5_error_code Aria-assigned error identifier. 0 indicates no error.<br>string a5_error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long a5_acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.<br>string a5_out_userid The user ID, unique among all accounts for this Aria client, assigned to the newly created account.  If input parameter &quot;user_id&quot; was provided, the same value will be returned.  If no &quot;user_id&quot; was provided as input and the client is configured within Aria for automatic generation of random user_id values OR is configured to use account email addresses as user_ids, the generated value will be returned.<br>string a5_out_client_acct_id The client_acct_id of this account, if one was supplied by the client.<br>long a5_invoicing_error_code Aria-defined error code specific to any error encountered during any invoicing/billing processes performed inline as a result of this method call.<br>string a5_invoicing_error_msg The explanatory text corresponding to the value returned (if any) in output &quot;invoicing_error_code&quot;.<br>long a5_invoice_no The unique identifer of the invoice, if any, created automatically by Aria in conjunction with this call.<br>string a5_proc_cvv_response The processor return code from CVV validation (deprecated)<br>string a5_proc_avs_response Processor return code from address validation<br>string a5_proc_cavv_response The processors return code for security validation (includes cvv)<br>string a5_proc_status_code The processor status code<br>string a5_proc_status_text The processors status description<br>string a5_proc_payment_id The processor payment id<br>string a5_proc_auth_code Authorization code provided by the issuing bank<br>string a5_proc_merch_comments Additional information passed to payment processor<br>hash a5_out_new_acct_plan_contracts <br>double a5_invoice_charges_before_tax Charges before tax on the initial invoice for this account<br>double a5_invoice_tax_charges Tax charges on the initial invoice for this account<br>double a5_invoice_charges_after_tax The sum of invoice_charges_before_tax and invoice_tax_charges<br>double a5_invoice_credit_amount The amount of credit on the initial invoice for this account<br>double a5_invoice_total_amount The total owed on the initial invoice for this account<br>hash a5_new_acct_invoice_line_items <br>hash a5_third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param long $reason_code The reason a given credt was/is to be applied to the account.
     ...
     * @param long $percent_eval_plan_no The plan number against which to apply the percent discount.
     * @param long $percent_eval_service_no The service to which the percent discount is to be applied.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string user_id The user ID of the account requested
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $plan_no The unique plan identifier.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_plan_contract 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $plan_no The unique plan identifier.
     * @param long $type_no The type of contract end action to be enforced by this contract.
     * @param double $alt_recur_fee The alternate recurring fee.
     * @param long $length_months The number of months (for example in reference to a contract).
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long contract_no This is the contract number for the account.
     */
     ...
     * @param long $contract_no This is the contract number for the account.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $type_no The type of contract end action to be enforced by this contract.
     * @param double $alt_recur_fee The alternate recurring fee.
     * @param long $length_months The number of months (for example in reference to a contract).
     ...
     * @param long $close_status Contract Closure Status (per the allowable values legend)
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $specified_usage_type_no The Aria-assigned usage type number to use when searching for usage history records.
     ...
     * @param hash $usage_qualifier_1 
     * @param hash $usage_qualifier_2 
     * @param hash $usage_qualifier_3 
     * @param hash $usage_qualifier_4 
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash usage_history_records A multidimensional array of usage history records attached to the account (and optional specified usage type) for given date range
     */
     ...
     * @param long $message_id Unique identifier of the message sent during provisioning to the account
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts..
     * @param string $do_encoding True indicates to acquire the message size after doing MIME encoding, False acquires message size without MIME encoding.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long num_chars The number of characters of the message_id requested.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>double proration_result_amount The currency amount of any resulting proration action performed as a result of the requested plan change. For plan assignments with an assignment directive of &#039;1&#039; (perform on anniversary date), or &#039;2&#039; (honor client default proration action) when the default configuration is to not do proration, or &#039;3&#039; (force no proration), the value returned in this field will always be &#039;0&#039;. When proration is performed the value returned in this field will either be a positive currency value (indicating a resulting charge to the account) or a negative currency value (indicating a credit to the account). If the value passed in field do_write is false then any positive or negative value returned in this field is notational only, demonstrating what proration effect would be applied to the account if the requested plan assignment/de-assignment were to be actually performed.<br>long collection_error_code If a collection is attempted, returns the error code associated with the collection.<br>string collection_error_msg The error message associated with collection_error_code.<br>long statement_error_code The error code if statement generation fails.<br>string statement_error_msg The text message associated with &#039;statement_error_code&#039;<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>long invoice_no The unique identifer of a given invoice.<br>hash cancelled_supp_plans An array containing the supplemental plans cancelled.<br>double expectd_activation_fee The activation fee the account holder can expect based on the activation fees of the plans on this invoice<br>double expectd_mthly_recurring_cost Regardless of the billing interval on the account, the monthly recurring cost of this change<br>double expectd_annu_recurring_cost <br>hash upd_acct_invoice_line_items <br>double total_charges_before_tax Total amount to be charged to the account before taxes have been calculated.<br>double total_tax_charges Total taxes as calculated for the amount of the transaction.<br>double total_charges_after_tax Total amount to be charged to the account after taxes have been calculated.<br>double total_credit The total amount of the credit to be applied to the account<br>double total_tax_credit The tax amount of the credit to be applies<br>double total_credit_before_tax The credit to be applied before tax is taken into account<br>double total The grand total of this invoice<br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param long $master_plan_alt_rate_sched_no The alternate rate schedule number for the master subscription plan being considered.
     * @param long $master_plan_units This is multiplier variiable for the recurring rate on the plan. Generally this value is 1, indicating the face value of the plan&#039;s recurring fee is used.
     * @param long $master_plan_assign_directive The scope rule to be applied to this assignment/de-assignment request, governing both the date upon which the assignment should take place (immediately or on the account&#039;s anniversary date) and the proration rule that should be applied (per client&#039;s default rules for proration on plan assignment v. forcing proration on or off for this request only). Default behavior is to assign plan to account on the account&#039;s anniversary date, resulting in no proration effect.
     * @param hash $update_acct_supp_field Array of supplemental field values to be updated.
     * @param hash $update_acct_func_group Array of functional groups to update.
     * @param hash $update_acct_coll_group Array of account collection groups to update
     * @param long $status_cd This is the status of the object inquestion for the current API call.
     * @param long $notify_method If notification method is not provided, value will default to 1 (HTML email).
     * @param string $password Password for the given user
     * @param string $secret_question The users secret question recorded to recover a password.
     ...
     * @param string $address3 The third line of the address
     * @param string $bill_address3 The third line of the billing address
     * @param hash $usage_accumulation_config 
     * @param hash $enable_usage_pooling_plan_no 
     * @param hash $disable_usage_pooling_plan_no 
     * @param string $alt_client_acct_group_id The one-time collections account group  to use for this particular call.  The default on the account is not changed.
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param string $track_data2 The raw &quot;track 2&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param long $offset_interval If assigning a change on an anniversary day, the number of billing periods by which to delay that change
     * @param long $tax_exemption_level The tax exemption level of this account
     * @param long $cn_alt_msg_template_no The alternate email template number to use for this account
     * @param string $promo_cd This is the code provided the client  and used by the account holder during registration or when executing a transaction. A promotion generally provides access to a custom set of reduced-rate plans.
     * @param string $invoice_unbilled_usage Specifies the unbilled usage to be invoiced or not.
     * @param string $coupon_code A coupon code to apply to this account
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>double proration_result_amount The currency amount of any resulting proration action performed as a result of the requested plan change. For plan assignments with an assignment directive of &#039;1&#039; (perform on anniversary date), or &#039;2&#039; (honor client default proration action) when the default configuration is to not do proration, or &#039;3&#039; (force no proration), the value returned in this field will always be &#039;0&#039;. When proration is performed the value returned in this field will either be a positive currency value (indicating a resulting charge to the account) or a negative currency value (indicating a credit to the account). If the value passed in field do_write is false then any positive or negative value returned in this field is notational only, demonstrating what proration effect would be applied to the account if the requested plan assignment/de-assignment were to be actually performed.<br>long collection_error_code If a collection is attempted, returns the error code associated with the collection.<br>string collection_error_msg The error message associated with collection_error_code.<br>long parent_child_sync_error_code The result of the synchronization of the parent/child billing dates (if attempted).<br>string parent_child_sync_error_msg The corresponding text error message for the parent_child_sync_error_code value.<br>long master_plan_error_code Error code returned upon failure when attempting to update the master plan<br>string master_plan_error_msg Human-readable error message corresponding to master_plan_error_code<br>long master_plan_coll_error_code Error code for master plan collection errors.<br>string master_plan_coll_error_msg Human-readable error text corresponding to the master_plan_coll_error_code<br>long master_plan_stmt_error_code Error code returned upon failure to update the master plan statement<br>string master_plan_stmt_error_msg Human-readable error message corresponding to master_plan_stmt_error_code.<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>long invoice_no The unique identifer of a given invoice.<br>hash cancelled_supp_plans <br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param string $start_date_range The start-date of the given date range.
     * @param string $end_date_range The end-date of the given date range
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_receipt An array of account receipt records.
     */
     ...
     * @param long $resource_threshold_level The value at which resources should be replenished.
     * @param long $resource_balance The remaining units left of the resource
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts..
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $exemption_level Exemption level code
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long exemption_level Exemption level code<br>string exemption_level_desc Exemption level text description
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash unapplied_service_credits A multidimensional array of service credit records for the given account
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $filter_credit_no The recurring credit number to use in order to filter results.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash recurring_credit_info 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long invoice_no The unique identifer of a given invoice.
     */
     ...
     * @param long $service_no Aria assigned unique service identifier
     * @param hash $custom_acct_rates This is a multidimensional array containing elements with the attributes rate_seq_no, rate_per_unit, from_unit, to_unit.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $plan_no The unique plan identifier.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $pay_method Determines if this is a credit card or bank account being searched against
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash accts_with_pay_method 
     */
     ...
     * @param long $action_directive Defines what to do with any pending invoices upon adjustment.
     * @param long $adjustment_days Number of days to adjust the billing date.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $comments Additional explanitory text relating to this API call.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_comments 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param hash $acct_supp_fields This is a multidimensional array containing the elements supp_field_name,  supp_field_value and supp_field_directive.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $start_date Specifies start date. The date is in the format yyyy-mm-dd
     * @param string $end_date Specifies end date. The date is in the format yyyy-mm-dd
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash statement_history 
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash invoice_history 
     */
     ...
     * @param long $statement_no The unique ID of the statement for which the details are being fetched
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $do_encoding True indicates to acquire the message size after doing MIME encoding, False acquires message size without MIME encoding.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string statement_content The contents of the statement<br>string mime_type MIME type for statement encoding.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $do_encoding True indicates to acquire the message size after doing MIME encoding, False acquires message size without MIME encoding.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long num_chars The size of the message as a count of characters.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long ordered_ind Boolean value indicating the SKU has been ordered<br>long billed_ind Boolean value indicating the SKU has been billed to the customer.<br>long paid_ind Boolean value indicating the product or service has been paid for.
     */
     ...
     * @param string $sku Client-assigned SKU code for product or service being referenced.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long acct_no The unique account number of the account which has ordered the item<br>long ordered_ind Boolean value indicating the SKU has been ordered<br>long billed_ind Boolean value indicating the SKU has been billed to the customer.<br>long paid_ind Boolean value indicating the product or service has been paid for.
     */
     ...
     * @param hash $supp_plans_to_assign 
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $assignment_directive The scope rule to be applied to this assignment/de-assignment request, governing both the date upon which the assignment should take place (immediately or on the account&#039;s anniversary date) and the proration rule that should be applied (per client&#039;s default rules for proration on plan assignment v. forcing proration on or off for this request only). Default behavior is to  assign plan to account on the account&#039;s anniversary date, resulting in no proration effect.
     * @param string $do_write Boolean indicator informing Aria whether or not to actually perform the requested plan assignment/de-assignment. If &#039;false&#039; is passed in this field Aria will, if applicable, calculate any potential proration effect that would result from this call and return that value in the output field &#039;proration_result_amount&#039; described below without actually performing the requested operation or charging/crediting the account. This is useful to interfaces that wish to present the user with a &#039;confirmation page&#039; informing of the would-be effects of the requested operation prior to actually performing it.
     * @param string $comments Additional explanitory text relating to this API call.
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $filter_seq_no An Aria-assigned billiing sequence number used to filter results.
     * @return mixed[] hash acct_pay_methods <br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @return mixed[] long statement_no The unique statement number.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $contract_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long type_no The type of contract end action to be enforced by this contract.<br>long length_months The number of months, starting from start_date, that the given contract will be in effect.<br>string create_comments CSR or API-provided comments provided at time of contract creation.<br>string update_comments Comments provided at time of last contract update.<br>string create_date The date the contract was created.<br>string update_date The date the contract was last modified.<br>string start_date Specifies contract start date. The date is in the format yyyy-mm-dd<br>string end_date Contract end date<br>string status_code Status code of this contract.<br>hash plan_no Aria assigned unique plan identifier<br>hash plan_name 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param hash $plan_no Aria assigned unique plan identifier
     * @param long $type_no The type of contract end action to be enforced by this contract.
     * @param long $length_months The number of months, starting from start_date, that the given contract will be in effect.
     * @param string $create_comments CSR or API-provided comments provided at time of contract creation.
     * @param string $start_date Specifies contract start date. The date is in the format yyyy-mm-dd
     * @param string $do_auto_discard Specifies whether or not, upon creation of this contract, whether or not the system should automatically discard any existing contracts in-effect that cover the same plan or set of plans.
     * @param string $end_date Allows the caller to set a specific end date when creating or modifying plan contracts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long contract_no Aria assigned unique contract identifier
     */
     ...
     * @param long $contract_no Aria assigned unique contract identifier
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $type_no The type of contract t the end action to be enforced by this contract.
     * @param long $length_months The number of months, starting from start_date, that the given contract will be in effect.
     * @param string $start_date Specifies contract start date. The date is in the format yyyy-mm-dd
     * @param string $update_comments Comments provided at time of last contract update.
     * @param long $modify_directive Whether to add or remove the contract
     * @param hash $plans_input 
     * @param string $end_date Allows the caller to set a specific end date when creating or modifying plan contracts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash all_acct_active_contracts The list of all contracts currently in effect for the given account.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $hierarchy_filter Specifies the filter which may be parent only, child only or complete hierarchy.
     * @param long $include_current_acct Specifies the current account to be included or not.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_hierarchy_details 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $filter_status_code The filter_status_code is the Aria code used to filter account contract for Inactive or Active (0 or 1).
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash all_acct_contracts 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $limit_records An input to limit the number of records returning back.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash acct_credits 
     */
     ...
     * @param long $credit_no Aria assigned unique identifier
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string created_by Specifies the user ID that created the transaction.<br>string created_date Specifies the date the credit was created.<br>double amount The amount of service credit to create on the account.<br>string credit_type The type of credit: e.g. service or cash.<br>double applied_amount The amount of credit to be applied to the account.<br>double unapplied_amount Amount remaining of the total credit to apply to account.<br>long reason_code Reason code for why the credit was created.<br>string reason_text The text description of the credit reason code.<br>string comments Additional explanitory text relating to this API call.
     */
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash credit_reason_codes 
     */
     ...
     * @param long $acct_no Aria-assigned unique account identifier.
     ...
     * @param hash $plans_to_get_outage 
     ...
     * @param long $transaction_id The unique identifier for a given transaction
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long invoice_no The unique identifer of a given invoice.<br>long acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     */
     ...
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @return mixed[] long new_transaction_id This is the resulting transaction ID from the void action.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $transaction_id The unique identifier for a given transaction
     * @param string $comments Additional explanitory text relating to this API call.
     * @return mixed[] long new_transaction_id This is the new transaction ID returned after successfully reinstating the transaction.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $source_account_no The Source account is the account who&#039;s entire balance will be credited and a the amount applied to the specified Target account.
     * @param long $target_account_no The Target account is the account that will received a debit for the entire balance of the Source account.
     * @return mixed[] long transaction_id The unique identifier for a given transaction<br>double balance_transferred The amount of money transferred from the Source to the Target account for this transaction.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $bill_immediately Indicates whether to bill the account holder immediately or, if not set bill on next billing anniversary date.
     * @param hash $order_line_items This is an array of line items appearing on the order. The Array elements for this argument immediately follow and are indicated as elements with a right-arrow icon.
     * @param long $bill_seq The unique identifier of the bill sequence number.
     ...
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param string $track_data2 The raw &quot;track 2&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param long $alt_inv_template_no The statement template to use when generating a statement for this order
     * @return mixed[] long order_no The unique identifier for an order in the context of an client_no and account_no.<br>long transaction_id The unique identifier for a given transaction<br>long statement_error_cd Error code produced when statement generation has failed.<br>string statement_error_msg The text message associated with &#039;statement_error_code&#039;<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>long invoice_no The unique identifer of a given invoice.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>double total_charges_before_tax Total charges on this invoice before taxes are applied<br>double total_tax_charges Total amount of taxes charged<br>double total_charges_after_tax Subtotal combining the total pre-tax charges and the total taxes charged<br>double total_credit Sum of all the credits on the invoice<br>hash cart_invoice_line_items All of the items on this order. If do_write was FALSE, these are the line items which would be on the eventual invoice<br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
    public function create_order($account_no, $bill_immediately, $order_line_items = null, $bill_seq = null, $client_order_id = null, $client_receipt_id = null, $alt_pay_method = null, $cc_number = null, $cc_expire_mm = null, $cc_expire_yyyy = null, $bank_routing_num = null, $bank_acct_num = null, $bill_company_name = null, $bill_first_name = null, $bill_middle_initial = null, $bill_last_name = null, $bill_address1 = null, $bill_address2 = null, $bill_city = null, $bill_locality = null, $bill_state_prov = null, $bill_zip = null, $bill_country = null, $bill_email = null, $bill_phone = null, $bill_phone_extension = null, $bill_cell_phone = null, $bill_work_phone = null, $bill_work_phone_extension = null, $cvv = null, $bill_address3 = null, $do_write = null, $coupon_cd = null, $alt_client_acct_group_id = null, $track_data1 = null, $track_data2 = null, $alt_inv_template_no = null)
    {
     ...
     * @param long $bill_seq The unique identifier of the bill sequence number.
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @param hash $specific_charge_transaction_id A list of specific charges, see below
     * @param long $alt_pay_method If you wish to use the account&#039;s current form of payment, leave this value empty. If you wish to use an alternate credit card, enter &#039;1&#039; for this value.
     * @param string $cc_number Credit card number.
     * @param long $cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param string $track_data2 The raw &quot;track 2&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param long $payment_application_method Possible values are 1, 2, or NULL. 1 is FIFO.  2 is First-DUE-First-Out.  If NULL, defaults to FIFO
     * @return mixed[] long transaction_id The unique identifier for a given transaction<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @param hash $specific_charge_transaction_id A list of specific charges, see below
     * @param long $external_destination_id The external system from which this payment originated
     * @param string $external_id The ID of the corresponding record to this payment in the external system
     * @return mixed[] long transaction_id The unique identifier for a given transaction<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
    public function record_external_payment($account_no, $payment_amount, $reference_code = null, $comments = null, $client_receipt_id = null, $specific_charge_transaction_id = null, $external_destination_id = null, $external_id = null)
    {
     ...
     * @param long $credit_reason_code The reason a given credt was/is to be applied to the account.
     * @param string $comments Additional explanitory text relating to this API call.
     * @return mixed[] long credit_id This identifier is returned upon successful application of credit and indicates the specific credit transaction executed against the account.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param hash $standing_order Multidimensional array &quot;standing_order&quot;: The standing_order array represent order-based (i.e. one-time purchased) items, and valid values must be pre-defined in Aria&#039;s inventory table structure.
     * @param string $client_order_id This is the client-assigned order identifier.
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @return mixed[] long standing_order_no Aria-assigned unique identifier for the standing order record created.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $standing_order_no Aria-assigned unique identifier for the standing order record created.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $payment_id Aria Event number of payment event.
     * @param hash $specific_charge_transaction_id A list of specific charges, see below
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param hash $usage_records 
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash error_records If client record IDs are provided, an array of error codes and error messages for individual records
     */
     ...
     * @param long $usage_type Aria-assigned identifier for the type of usage being recorded. Please consult Aria support representatives for a list of allowable usage_type values for the given client.
     ...
     * @param long $parent_usage_rec_no The Aria-assigned parent usage record identifier for a child account.
     ...
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long usage_rec_no Aria-assigned usage record identifier
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $my_order_no If this value is not null, then information about this specific order number will be retrieved. If null, then all orders for the given acct_no will be retrieved.
     * @param string $my_client_order_id Client specified order id.
     * @param long $limit_records Limits the number of records which are returned.
     * @param long $details_flag If 1, also returns the order line items
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash order An array containing the order record
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $my_standing_order If this value is not null, then information about this specific standing order number will be retrieved. If null, then all standing order for the given acct_no will be retrieved.
     * @param string $my_client_order_id Client defined order id.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash so 
     */
     ...
     * @param long $standing_order_no Standing Order number to query.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash so_items An array containing the standing order items.
     */
     ...
     * @param long $standing_order_no Unique ID for this standing order.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash order An array containing related order history records.
     */
     ...
     * @param string $address2 second address line of the contact
     * @param string $city City of the contact
     * @param string $state_prov_code State or Province of the contact
     * @param string $zip_code Postal/Zip code for the contact address.
     * @param string $country_code Country of the contact
     * @param string $currency_code ISO Currency code for this transaction
     * @param hash $pre_calc_plan 
     * @param hash $pre_calc_sku 
     * @param long $tax_exempt_cd Tax exemption status (this is not part of the above arrays). For Aria taxes, 0=not exempt, 1=exempt from state taxes, 2=exempt from country taxes, 3=exempt from state and country taxes. Values may be different for client&#039;s custom tax servers.
     * @param string $address3 The third line of the address
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash inv_calc_out <br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param long $order_no The unique identifier for an order in the context of an client_no and account_no.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash order_items 
     */
     ...
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @param long $alt_bill_day Alternate bill day.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long invoice_no The unique identifer of a given invoice.<br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string out_statement The returned account statement.<br>string mime_type MIME type for statement encoding.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $do_encoding True indicates to acquire the message size after doing MIME encoding, False acquires message size without MIME encoding.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long num_chars The number of the characters in the statement.
     */
     ...
     * @param long $src_transaction_id Either the Aria transaction ID or the Aria invoice number for the invoice
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash invoice_line_items Array of invoice line items for this invoice.<br>long is_pending_ind Whether or not this invoice is pending
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $src_transaction_id Either the Aria transaction ID or the Aria invoice number for the invoice
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash invoice_payments Array of invoice payments returned upon succesful completion of the API call.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $src_transaction_id Aria transaction ID for the credit transaction (e.g., Payment)
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash payment_applications An Array of payment applications.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash receipt_action 
     */
     ...
     * @param long $invoice_no The unique identifer of a given invoice.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param long $action_directive Identifies which action to take on the pending invoice. If null, defaults to &quot;approve pending invoice&quot;.
     * @param long $bill_seq The unique identifier of the bill sequence number.
     * @param long $alt_pay_method If you wish to use the account&#039;s current form of payment, leave this value empty. If you wish to use an alternate credit card, enter &#039;1&#039; for this value.
     * @param string $cc_number Credit card number.
     * @param long $cc_expire_mm Expiration month for the credit card payment instrument.
     ...
     * @param string $bill_state_prov State or Province of the billing contact
     * @param string $bill_zip Zip Code of the billing contact
     * @param string $bill_country ISO-compliant 2-country code abbreviation for the billing address country
     * @param string $bill_email Email of the billing contact
     * @param string $bill_phone Phone of the billing contact
     * @param string $bill_phone_extension Phone extension of the billing contact
     * @param string $bill_cell_phone Cell phone of the billing contact
     ...
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param string $track_data2 The raw &quot;track 2&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @return mixed[] long new_invoice_no The new invoice number generated.<br>long collection_error_code If a collection is attempted, returns the error code associated with the collection.<br>string collection_error_msg The error message associated with collection_error_code.<br>long statement_error_code Error code for statement generation failure.<br>string statement_error_msg The text message associated with &#039;statement_error_code&#039;<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param string $include_voided Include voided invoices in the search results.
     * @param long $aria_event_no Aria Event number of the writeoff event
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash refund_details 
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @param hash $order_line_items 
     * @param hash $cart_supp_plans 
     * @param string $client_order_id This is the client-assigned order identifier.
     * @param string $coupon_code The code of the coupon to which to apply the discount.  If code is not valid for any reason, an appropriate error code is returned and the entire transaction (including the supp plan assignment and any possible invoice creation) is rolled back.
     * @param string $comments Additional explanitory text relating to this API call.
     * @param string $do_write Boolean indicator informing Aria whether or not to actually perform the requested plan assignment/de-assignment. If &#039;false&#039; is passed in this field Aria will, if applicable, calculate any potential proration effect that would result from this call and return that value in the output field &#039;proration_result_amount&#039; described below without actually performing the requested operation or charging/crediting the account. This is useful to interfaces that wish to present the user with a &#039;confirmation page&#039; informing of the would-be effects of the requested operation prior to actually performing it.  Do_write defaults to &#039;true&#039;
     * @param string $client_receipt_id Client defined unique identifier used to track related system actions
     * @param long $bill_seq The billing sequence number
     * @param long $alt_pay_method If you wish to use the account&#039;s current form of payment, leave this value empty. If you wish to use an alternate credit card, enter &#039;1&#039; for this value.
     * @param string $cc_number Credit card number.
     * @param long $cc_expire_mm Expiration month for the credit card payment instrument.
     * @param long $cc_expire_yyyy Expiration year for the credit card payment instrument.
     ...
     * @param string $bill_state_prov State or Province of the billing contact
     * @param string $bill_zip Zip Code of the billing contact
     * @param string $bill_country The ISO-compliant 2-character country code for the billing address
     * @param string $bill_email Email of the billing contact
     * @param string $bill_phone Phone of the billing contact
     * @param string $bill_phone_extension Phone extension of the billing contact
     * @param string $bill_cell_phone Cell phone of the billing contact
     ...
     * @param string $track_data1 The raw &quot;track 1&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param string $track_data2 The raw &quot;track 2&quot; data from a swiped credit card used in a card-present transaction to initiate this request
     * @param long $alt_inv_template_no The invoice template number to use for this order, if different from the default template
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>long order_no The unique identifier for an order in the context of an client_no and account_no.<br>long invoice_no The unique identifer of a given invoice.<br>hash cart_invoice_line_items <br>long collection_error_code If a collection is attempted, returns the error code associated with the collection.<br>string collection_error_msg The error message associated with collection_error_code.<br>long statement_error_code The error code generated by Aria when Aria attempted to generate a statement<br>string statement_error_msg The text message associated with &#039;statement_error_code&#039;<br>long transaction_id The unique identifier for a given transaction<br>string proc_cvv_response The processor return code from CVV validation (deprecated)<br>string proc_avs_response Processor return code from address validation<br>string proc_cavv_response The processors return code for security validation (includes cvv)<br>string proc_status_code The processor status code<br>string proc_status_text The processors status description<br>string proc_payment_id The processor payment id<br>string proc_auth_code Authorization code provided by the issuing bank<br>string proc_merch_comments Additional information passed to payment processor<br>hash third_party_errors Errors from third-party systems like taxation engines are returned here, whereas the Aria-generated error codes are returned in the error_code and error_msg fields at the root level of the API return.
     */
     ...
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash refundable_payments 
     */
     ...
     * @param long $payment_transaction_id The payment transaction by which to search for invoices
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash reversible_invoices 
     */
     ...
     * @param long $payment_transaction_id The Aria-generated transaction ID of the payment made.
     * @param long $reason_code The refund reason code.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     ...
     * @param long $aria_event_no Aria Event number of the writeoff event
     * @param long $acct_no Aria-assigned unique identifier indicating each email template created in Aria.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash writeoff_details A multidimensional array containing the details of all writeoffs applied to an account.
     */
     ...
     * @param long $xml_statement_no The unique xml statement number.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>string xml_statement_content The xml statement content.
     */
     ...
     * @param string $start_date Specifies start date. The date is in the format yyyy-mm-dd
     * @param string $end_date Specifies end date. The date is in the format yyyy-mm-dd
     * @param long $limit_records Specifies the number of payment transactions to be returned. There will be no limits if not specified.
     * @param long $details_flag If 1, also return the details for the payments
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash payment_history An Array of payment details.
     */
     ...
     * @param long $transaction_id Payment transaction ID for which the application details are to be retrieved.
     * @param long $acct_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts.
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash payment_application_details An Array of account payment application details.
     */
     ...
     * @param hash $usage_record_nos 
     * @param hash $client_record_ids 
     * @param long $exclusion_reason_cd The exclude reason code, defining why these usage records are being removed
     * @param string $exclusion_comment Optional comment on the reason behind this API call
     * @return mixed[] long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.<br>hash failed_records 
     */
     ...
     * @param string $user_id Account&#039;s user ID. Alternative to using acct_no.
     * @param string $password Password for the given user
     * @return mixed[] string session_id Client-assigned identifier for the application session.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $user_id Account&#039;s user ID. Alternative to using acct_no.
     * @param long $acct_no Account&#039;s Account #.  Alternative to using user ID
     * @return mixed[] string session_id Client-assigned identifier for the application session.<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
     ...
     * @param string $session_id Client-assigned identifier for the application session.
     * @return mixed[] string user_id Account&#039;s user ID. Alternative to using acct_no.<br>long account_no Aria-assigned account identifier. This value is unique across all Aria-managed accounts..<br>long error_code Aria-assigned error identifier. 0 indicates no error.<br>string error_msg Textual description of any error that occurred.  &quot;OK&quot; if there was no error.
     */
